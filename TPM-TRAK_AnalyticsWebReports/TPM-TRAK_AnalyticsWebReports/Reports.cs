...
namespace TPM_TRAK_AnalyticsWebReports
{
    public class Reports
    {
        ...
        public static bool PlotProdReportMachinewiseFormat1Day(string Path, string Destination, string fromDate, string toDate, string shift, string plantId, DataTable daywiseProdData, bool WorkOrder, string timeFormat, bool isQERequired)
        {
            bool Saved = false;
            FileInfo newFile = new FileInfo(Path);
            ExcelPackage Excel = new ExcelPackage(newFile, true);
