<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HelpRequestProductionAndon.aspx.cs" Inherits="Web_TPMTrakDashboard.Advik.Andon_Advik.HelpRequestProductionAndon" %>
                        ...
                        <div class="navbar navbar-default navbar-fixed-top text-center" style="padding: 0px 5px; background-color: #3777bc">
                            ...
                            <div style="float: right; position: relative; display: inline-flex">
                                ...
                                <div style="text-align: left">
                                    ...
                                    <%--    <asp:DropDownList runat="server" ID="ddlCellID" ClientIDMode="Static" CssClass="form-control" OnSelectedIndexChanged="ddlCellID_SelectedIndexChanged" AutoPostBack="true" Style="margin-top: 0px">
                                        </asp:DropDownList>--%>
                                    </div>
                                </div>
                                &nbsp;&nbsp;
                                            ...
                                            <table id="lvPODataTbl" runat="server" clientidmode="static">
                                                <tr>
                                                    ...
                                                    <th id="thComponent" runat="server">
                                                        <img src="Images/Printer1.png" class="imgInHeader" runat="server" /><br />
                                                        <label runat="server" id="lblComponent">Matl</label>
                                                    </th>
                                                    <th id="thSetting" runat="server">
                                                        <img src="Images/Settings-icon.png" class="imgInHeader" runat="server" /><br />
                                                        <label runat="server" id="lblSetting">Maint</label>
                                                    </th>
                                                    <th id="thTimer" runat="server">
                                                        <img src="Images/Alarm-clock.png" class="imgInHeader" runat="server" /><br />
                                                        <label runat="server" id="lblTimer">Insp</label>
                                                    </th>
                                                    <th id="thUser" runat="server">
                                                        <img src="Images/UserL.png" class="imgInHeader" runat="server" /><br />
                                                        <label runat="server" id="lblUser">Supr</label>
                                                    </th>
