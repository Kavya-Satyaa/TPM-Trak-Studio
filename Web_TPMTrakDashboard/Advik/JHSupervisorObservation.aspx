<%@ Page Title="JH Supervisor" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="JHSupervisorObservation.aspx.cs" Inherits="Web_TPMTrakDashboard.Advik.JHSupervisorObservation" %>
        ...
        <ContentTemplate>
            ...
            <table id="tblfilter" class="table table-bordered" style="width: auto;">
                <tr>
                  ...
                  <%--      <asp:ListBox ID="ddlShift" runat="server" SelectionMode="Multiple" ToolTip="<%$Resources:CommanResource,ShiftTooltip %>" Width="150" ClientIDMode="Static"></asp:ListBox>--%>
                        <asp:DropDownList runat="server" ID="ddlShifts" CssClass="form-control" Width="150" ClientIDMode="Static"></asp:DropDownList>
                    </td>
            ...
            <div style="display: flex; justify-content: center; align-content: center;">
                <div id="gridContainer" class="divGrid" style="">
                    <asp:ListView runat="server" ID="lvSupervisorObs">
                        <LayoutTemplate>
                            <table id="tblSupervisorObs" class="table table-bordered cockpit headerFixerTable">
                                <tr>
                                    <th>Date</th>
                                     <th>Machine ID</th>
                                     <th>Shift</th>
                        ...
                        <ItemTemplate>
                            <tr class='<%# Eval("BackColor") %>'>
                                <td><asp:HiddenField runat="server" ID="hdnAuditDate"  Value='<%# Eval("AuditDate") %>'/> <asp:Label runat="server" ID="lblDate" Text='<%# Eval("Date") %>'></asp:Label></td>
                                <td> <asp:Label runat="server" ID="lblMachineID"  Text='<%# Eval("Machine") %>'></asp:Label></td>
                                ...
                                <td style="text-align:center">
                                     <asp:HiddenField runat="server" ID="hdnSupUpdate" ClientIDMode="Static" />
                                    <asp:CheckBox runat="server" ID="chkSupObs" Checked='<%# Eval("SupervisorObservation") %>' onclick="supervisorChkChange(this)"/>
                                </td>
                                </tr>
                        </ItemTemplate>
                         <EmptyDataTemplate>
