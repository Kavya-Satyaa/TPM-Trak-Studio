<%@ Page Title="PM CheckList Master" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PMCheckListMaster.aspx.cs" Inherits="Web_TPMTrakDashboard.Advik.PMCheckListMaster" %>
                    ...
                    <div id="divChecklistMaster" class="divGrid" style="">
                        <asp:GridView runat="server" ID="gvChecklistMaster" AutoGenerateColumns="False" ClientIDMode="Static"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Checklist ID">
                                    <ItemTemplate>
            ...
            if ($('[id$=btnAdd]').val() == "Add") {
                ...
                if (checklistID != "" && checklistItem != "" && sortOrder != "") {
                    $.ajax({
                        ...
                        url: "PMCheckListMaster.aspx/IsRowPresent",
                ...
                if ($('[id$=btnAdd]').val() == "Add") {
                    ...
                    if (newChklistContents != null) {
                        ...
                        if (checklistID != "" && checklistItem != "" && sortOrder != "" && location != "" && stdcondition != "" && checkingmethod != "") {
                            ...
                            httpRequest.open('POST', 'PMCheckListMaster.aspx/IsRowPresent', false);
