...
{
    public partial class JHChecklistMasterAdvik184 : System.Web.UI.Page
    {
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    data.ChecklistItem = (gridViewRow.FindControl("txtChecklistItem") as TextBox).Text;
                    ...
                    foreach (GridViewRow gridViewRow in gvChecklistMaster.Rows)
                    {
                        if (gridViewRow.RowType != DataControlRowType.Header && gridViewRow.RowType != DataControlRowType.Footer)
                        {
                            ...
                            if (isUpdated.Equals("Update", StringComparison.OrdinalIgnoreCase))
                            {
                                ...
                                data.ChecklistItem= (gridViewRow.FindControl("txtIChecklistItem") as TextBox).Text;
                ...
                if (workBook != null)
                {
                    try
                    {
                        ...
                        for (var rowNum = startRow; rowNum <= lastRow; rowNum++)
                        {
                            ...
                            string mcarea = wsChecklistMaster.Cells[rowNum, 4].Value == null ? "" : wsChecklistMaster.Cells[rowNum, 4].Value.ToString();
                            string Location = wsChecklistMaster.Cells[rowNum, 5].Value == null ? "" : wsChecklistMaster.Cells[rowNum, 5].Value.ToString();
                            string StdCondition = wsChecklistMaster.Cells[rowNum, 6].Value == null ? "" : wsChecklistMaster.Cells[rowNum, 6].Value.ToString();
                            string CheckingMethod = wsChecklistMaster.Cells[rowNum, 7].Value == null ? "" : wsChecklistMaster.Cells[rowNum, 7].Value.ToString();
                            ...
                            int sortOrder = wsChecklistMaster.Cells[rowNum, 8].Value == null ? lastRowSortOrder + 1 : Convert.ToInt32(wsChecklistMaster.Cells[rowNum, 8].Value.ToString());
                            string jhType = wsChecklistMaster.Cells[rowNum, 9].Value == null ? "" : wsChecklistMaster.Cells[rowNum, 9].Value.ToString();
                            ...
                            tblRow[3] = mcarea;
                            tblRow[4] = Location;
                            tblRow[5] = StdCondition;
                            tblRow[6] = CheckingMethod;
                            //tblRow[3] = NoOfCycle;
                            tblRow[7] = true;
                            tblRow[8] = sortOrder;
                            tblRow[9] = jhType;
