...
{
    public partial class COPAllied : System.Web.UI.Page
    {
        int RowIndex = 0;
        ...
        private void SetValuesToControls(DataTable dt, int index)
        {
            ...
            if (dt != null && dt.Rows.Count > 0)
            {
                ...
                txtStdTestPressure.Text = dt.Rows[RowIndex]["StdTestPressure"].ToString();
                txtStdHoldingTime.Text = dt.Rows[RowIndex]["StdHoldingTime"].ToString();
        ...
        protected void btnnew_Click(object sender, EventArgs e)
        {
            ...
            txtStdHoldingTime.Text = string.Empty;
            txtStdTestPressure.Text = string.Empty;
            btnUpdateStdTime.Visible = false;
        }
        #endregion
        ...
        protected void btnsave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                DataBaseAccess.InsertOrUpdateComponentIdDetailsForAllied (txtsearch.Text, "", "", txtdescription.Text.ToString(), "", "", "", txtopn_no.Text.ToString(), MachineIds,
                ...
                txtmachinetime.Text.ToString(), txtsubop.Text.ToString(), txtsetuptime.Text.ToString(), txtcuttingtime.Text.ToString(), txttarget.Text.ToString(),
                 Session["UserName"].ToString(), "", "", "", "", "", "", "", "", "", "", "", FinishOperation, "InsertCompOpnInfo", txtminLoadUnloadThreshold.Text,txtStdTestPressure.Text,txtStdHoldingTime.Text, out isSuccessFailure);
                if (isSuccessFailure)
                {
                    rowAdded = true;
                }
