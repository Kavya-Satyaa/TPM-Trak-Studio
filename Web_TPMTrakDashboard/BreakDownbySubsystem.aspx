<%@ Page Title="" Language="C#" Async="true" Trace="false" AsyncTimeout="6000"  MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="BreakDownbySubsystem.aspx.cs" Inherits="Web_TPMTrakDashboard.BreakDownbySubsystem" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
  ...
  <%--  <script src="Content/Multi/locales/bootstrap-datepicker.zh-CN.min.js"></script>
        ...
        <ContentTemplate>
                ...
                <table class="table table-bordered" id="tblfilter">
                    <tr>
                        ...
                        <td>
                            <asp:ListBox ID="ddlMachineId" runat="server" SelectionMode="Multiple" ToolTip="<%$ Resources:CommanResource, MachineTooltip %>" Width="150px" ClientIDMode="Static"></asp:ListBox></td>
                        <td class="commontd">
                    ...
                    <tr>
                       ...
                       <%--     <asp:TextBox ID="txtFromDate" runat="server" CssClass="form-control date" data-toggle="tooltip"
                                title="From Date !" placeholder="From Date" ToolTip="<%$ Resources:CommanResource, FromDate %>" AutoCompleteType="Disabled" TextMode="DateTimeLocal" Width="220px" meta:resourcekey="txtFromDateResource1"></asp:TextBox>--%>
                        ...
                        <td class="input-group" style="padding-bottom: 10px; padding-top: 10px;">
                          ...
                          <%--  <asp:TextBox ID="txtToDate" runat="server" CssClass="form-control date" data-toggle="tooltip"
                                title="To Date !" placeholder="To Date" ToolTip="<%$ Resources:CommanResource, ToDate %>" AutoCompleteType="Disabled" TextMode="DateTimeLocal" Width="220px" meta:resourcekey="txtToDateResource1"></asp:TextBox>--%>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlTopDownReasons" runat="server" CssClass="select form-control" meta:resourcekey="ddlTopDownReasonsResource1" >
                                ...
                                <asp:ListItem Value="11" meta:resourcekey="ListItemResource11">Top 11</asp:ListItem>
                                <asp:ListItem Value="12" meta:resourcekey="ListItemResource12">Top 12</asp:ListItem>
                                <asp:ListItem Value="13" meta:resourcekey="ListItemResource13">Top 13</asp:ListItem>
                                <asp:ListItem Value="14" meta:resourcekey="ListItemResource14">Top 14</asp:ListItem>
                                <asp:ListItem Value="15" meta:resourcekey="ListItemResource15">Top 15</asp:ListItem>
                                <asp:ListItem Value="16" meta:resourcekey="ListItemResource16">Top 16</asp:ListItem>
                                <asp:ListItem Value="17" meta:resourcekey="ListItemResource17">Top 17</asp:ListItem>
                                <asp:ListItem Value="18" meta:resourcekey="ListItemResource18">Top 18</asp:ListItem>
                                <asp:ListItem Value="19" meta:resourcekey="ListItemResource19">Top 19</asp:ListItem>
                                <asp:ListItem Value="20" meta:resourcekey="ListItemResource20">Top 20</asp:ListItem>
                            </asp:DropDownList>
                        </td>
                        <td colspan="2" style="text-align: left">
                            ...
                            <asp:Button runat="server" Text="<%$ Resources:CommanResource, Process %>" class="btn btn-info btn-sm" ID="btnProcess" OnClick="btnProcess_Click" Style="margin-left: 15px;" meta:resourcekey="btnProcessResource1"></asp:Button>
                        </td>
                    </tr>
                </table>
        </ContentTemplate>
    ...
    <ul class="nav nav-pills">
        ...
        <li><a class="menuData" data-toggle="tab" href="#menu3"><%=GetLocalResourceObject("Top - 5 Down by MCsh") %>     </a></li>
    ...
    <div class="tab-content">
        ...
        <div id="menu1" class="tab-pane fade">
            ...
            <div id="tblGrid1" class="row manageData gridHeightSetter" style="min-width: 700px; overflow-x: scroll; padding-top: 0px;">
    ...
    <script>
        $(document).ready(function () {
        	...
        	//        url: "BreakDownbySubsystem.aspx/GetCellIdData",
            //        data: '{PlantId:"' + value + '"}',
            //        dataType: "json",
            ...
            //        type: "POST",
            //        contentType: "application/json; charset=utf-8",
        	//        url: "BreakDownbySubsystem.aspx/GetMachineIdData",
        ...
        function GetFirstDownTimeData() {
            $.ajax({
                type: "POST",
                url: "BreakDownbySubsystem.aspx/MCsbyTopDownsChart",
                contentType: "application/json; charset=utf-8",
        ...
        function GetSecondDownTimeData() {
            $.ajax({
                type: "POST",
                url: "BreakDownbySubsystem.aspx/TopDownbyMCChart",
                contentType: "application/json; charset=utf-8",
                data: '{plantID:"' + $("[id$=ddlPlantId]").val() + '",machineId:"' + $("[id$=ddlMachineId]").val() + '",startFromDate:"' + $("[id$=txtFromDate]").val() + '",startToDate:"' + $("[id$=txtToDate]").val() + '",downID:"' + $("[id$=ddlMultiDownID]").val() + '",exclude:"' + $("[id$=chkExclude]").prop('checked') + '",downReasons:"' + $("[id$=ddlTopDownReasons]").val() + '",CellID:"' + $("[id$=ddlCellID]").val() + '"}',
                dataType: "json",
        ...
        function bindChartTimeWiseFun(data,sizeLable) {
            ...
            function GetFirstDownFreqData() {
                $.ajax({
                    type: "POST",
                    url: "BreakDownbySubsystem.aspx/MCsbyTopDownFreqChart",
                    contentType: "application/json; charset=utf-8",
                    data: '{plantID:"' + $("[id$=ddlPlantId]").val() + '",machineId:"' + $("[id$=ddlMachineId]").val() + '",startFromDate:"' + $("[id$=txtFromDate]").val() + '",startToDate:"' + $("[id$=txtToDate]").val() + '",downID:"' + $("[id$=ddlMultiDownID]").val() + '",exclude:"' + $("[id$=chkExclude]").prop('checked') + '",downReasons:"' + $("[id$=ddlTopDownReasons]").val() + '",CellID:"' + $("[id$=ddlCellID]").val() + '"}',
                    dataType: "json",
            ...
            function GetSecondDownFreqData() {
                $.ajax({
                    type: "POST",
                    url: "BreakDownbySubsystem.aspx/TopDownFreqbyMCsChart",
                    contentType: "application/json; charset=utf-8",
                    data: '{plantID:"' + $("[id$=ddlPlantId]").val() + '",machineId:"' + $("[id$=ddlMachineId]").val() + '",startFromDate:"' + $("[id$=txtFromDate]").val() + '",startToDate:"' + $("[id$=txtToDate]").val() + '",downID:"' + $("[id$=ddlMultiDownID]").val() + '",exclude:"' + $("[id$=chkExclude]").prop('checked') + '",downReasons:"' + $("[id$=ddlTopDownReasons]").val() + '",CellID:"' + $("[id$=ddlCellID]").val() + '"}',
                    dataType: "json",
            ...
            function bindTop5DownFreqbyMCChart(data,sizeLable) {
                ...
                function GetDownTimeParetoData() {
                    $.ajax({
                        type: "POST",
                        url: "BreakDownbySubsystem.aspx/TopDownTimeParetoChartColAndPie",
                        contentType: "application/json; charset=utf-8",
                        data: '{plantID:"' + $("[id$=ddlPlantId]").val() + '",machineId:"' + $("[id$=ddlMachineId]").val() + '",startFromDate:"' + $("[id$=txtFromDate]").val() + '",startToDate:"' + $("[id$=txtToDate]").val() + '",downID:"' + $("[id$=ddlMultiDownID]").val() + '",exclude:"' + $("[id$=chkExclude]").prop('checked') + '",downReasons:"' + $("[id$=ddlTopDownReasons]").val() + '",CellID:"' + $("[id$=ddlCellID]").val() + '"}',
                        dataType: "json",
                ...
                function GetCatagoryDownTimeParetoData() {
                    $.ajax({
                        type: "POST",
                        url: "BreakDownbySubsystem.aspx/CatagoryByDownTimeParetoChart",
                        contentType: "application/json; charset=utf-8",
                        data: '{plantID:"' + $("[id$=ddlPlantId]").val() + '",machineId:"' + $("[id$=ddlMachineId]").val() + '",startFromDate:"' + $("[id$=txtFromDate]").val() + '",startToDate:"' + $("[id$=txtToDate]").val() + '",downID:"' + $("[id$=ddlMultiDownID]").val() + '",exclude:"' + $("[id$=chkExclude]").prop('checked') + '",downReasons:"' + $("[id$=ddlTopDownReasons]").val() + '",CellID:"' + $("[id$=ddlCellID]").val() + '"}',
                        dataType: "json",
    		...
    		console.log(data);
                            ...
                            var chart = Highcharts.chart('container2', {
                                ...
                                series: [{
                                    ...
                                    name: '<%=GetLocalResourceObject("Down ID")%>',
                                    type: 'column',
                                    //colorByPoint: true,
                                    zIndex: 2,
                                    data: data.series,
                            ...
                            var chartCol = Highcharts.chart('container-col', {
                                ...
                                title: {
                                    ...
                                    formatter: function () {
                                    	...
                                    	return '<b>' + this.series.name + '</b><br/>' +
										 "Cumulative Value (%)" + ': ' + value.toFixed(2);
                                    }
                                },
                                yAxis: [{
                                    title: {
