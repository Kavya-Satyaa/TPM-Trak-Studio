<%@ Page Title="Break down Losses" Language="C#" AsyncTimeout="6000" Async="true" Trace="false" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Breakdownlosses.aspx.cs" Inherits="Web_TPMTrakDashboard.Breakdownlosses" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
  ...
  <%--  <script src="Content/Multi/locales/bootstrap-datepicker.zh-CN.min.js"></script>
    ...
    <div class="tab-content">
        ...
        <div id="menu7" class="tab-pane fade in active">
            ...
            <div id="container-col" style="min-width: 310px; height: 400px; margin: 0 auto"></div>
    ...
    <script>
        $(document).ready(function () {
        	...
        	//        url: "Breakdownlosses.aspx/GetCellIdData",
            //        data: '{PlantId:"' + value + '"}',
            //        dataType: "json",
            ...
            //        type: "POST",
            //        contentType: "application/json; charset=utf-8",
        	//        url: "Breakdownlosses.aspx/GetMachineIdData",
        ...
        function GetFirstDownTimeData() {
            $.ajax({
                type: "POST",
                url: "Breakdownlosses.aspx/MCsbyTopDownsChart",
                contentType: "application/json; charset=utf-8",
        ...
        function GetSecondDownTimeData() {
            $.ajax({
                type: "POST",
                url: "Breakdownlosses.aspx/TopDownbyMCChart",
                contentType: "application/json; charset=utf-8",
                data: '{plantID:"' + $("[id$=ddlPlantId]").val() + '",machineId:"' + $("[id$=ddlMachineId]").val() + '",startFromDate:"' + $("[id$=txtFromDate]").val() + '",startToDate:"' + $("[id$=txtToDate]").val() + '",downID:"' + $("[id$=ddlMultiDownID]").val() + '",exclude:"' + $("[id$=chkExclude]").prop('checked') + '",downReasons:"' + $("[id$=ddlTopDownReasons]").val() + '",CellID:"' + $("[id$=ddlCellID]").val() + '"}',
                dataType: "json",
        ...
        function bindChartTimeWiseFun(data,sizeLable) {
            ...
            function GetFirstDownFreqData() {
                $.ajax({
                    type: "POST",
                    url: "Breakdownlosses.aspx/MCsbyTopDownFreqChart",
                    contentType: "application/json; charset=utf-8",
                    data: '{plantID:"' + $("[id$=ddlPlantId]").val() + '",machineId:"' + $("[id$=ddlMachineId]").val() + '",startFromDate:"' + $("[id$=txtFromDate]").val() + '",startToDate:"' + $("[id$=txtToDate]").val() + '",downID:"' + $("[id$=ddlMultiDownID]").val() + '",exclude:"' + $("[id$=chkExclude]").prop('checked') + '",downReasons:"' + $("[id$=ddlTopDownReasons]").val() + '",CellID:"' + $("[id$=ddlCellID]").val() + '"}',
                    dataType: "json",
            ...
            function GetSecondDownFreqData() {
                $.ajax({
                    type: "POST",
                    url: "Breakdownlosses.aspx/TopDownFreqbyMCsChart",
                    contentType: "application/json; charset=utf-8",
                    data: '{plantID:"' + $("[id$=ddlPlantId]").val() + '",machineId:"' + $("[id$=ddlMachineId]").val() + '",startFromDate:"' + $("[id$=txtFromDate]").val() + '",startToDate:"' + $("[id$=txtToDate]").val() + '",downID:"' + $("[id$=ddlMultiDownID]").val() + '",exclude:"' + $("[id$=chkExclude]").prop('checked') + '",downReasons:"' + $("[id$=ddlTopDownReasons]").val() + '",CellID:"' + $("[id$=ddlCellID]").val() + '"}',
                    dataType: "json",
            ...
            function bindTop5DownFreqbyMCChart(data,sizeLable) {
                ...
                function GetDownTimeParetoData() {
                    $.ajax({
                        type: "POST",
                        url: "Breakdownlosses.aspx/TopDownTimeParetoChartColAndPie",
                        contentType: "application/json; charset=utf-8",
                        data: '{plantID:"' + $("[id$=ddlPlantId]").val() + '",machineId:"' + $("[id$=ddlMachineId]").val() + '",startFromDate:"' + $("[id$=txtFromDate]").val() + '",startToDate:"' + $("[id$=txtToDate]").val() + '",downID:"' + $("[id$=ddlMultiDownID]").val() + '",exclude:"' + $("[id$=chkExclude]").prop('checked') + '",downReasons:"' + $("[id$=ddlTopDownReasons]").val() + '",CellID:"' + $("[id$=ddlCellID]").val() + '"}',
                        dataType: "json",
                ...
                function GetCatagoryDownTimeParetoData() {
                    $.ajax({
                        type: "POST",
                        url: "Breakdownlosses.aspx/CatagoryByDownTimeParetoChart",
                        contentType: "application/json; charset=utf-8",
                        data: '{plantID:"' + $("[id$=ddlPlantId]").val() + '",machineId:"' + $("[id$=ddlMachineId]").val() + '",startFromDate:"' + $("[id$=txtFromDate]").val() + '",startToDate:"' + $("[id$=txtToDate]").val() + '",downID:"' + $("[id$=ddlMultiDownID]").val() + '",exclude:"' + $("[id$=chkExclude]").prop('checked') + '",downReasons:"' + $("[id$=ddlTopDownReasons]").val() + '",CellID:"' + $("[id$=ddlCellID]").val() + '"}',
                        dataType: "json",
