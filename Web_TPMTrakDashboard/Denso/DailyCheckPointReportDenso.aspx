<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DailyCheckPointReportDenso.aspx.cs" Inherits="Web_TPMTrakDashboard.Denso.DailyCheckPointReportDenso" %>
                                                ...
                                                <asp:ListView runat="server" ID="lvCheckpointValue" ClientIDMode="Static" ItemPlaceholderID="itemplaceholder3" DataSource='<%# Eval("ValueList") %>' OnItemDataBound="lvCheckpointValue_ItemDataBound">
                                                    ...
                                                    <ItemTemplate>
                                                        ...
                                                        <td class="td-actual-value" style='<%# "background-color:" + Eval("CheckpointTypeBackColor") + "; color:" + Eval("CheckpointTypeForeColor") %>'>
                                                            ...
                                                            <div runat="server" visible='<%# Eval("ContentVisibility") %>' style="min-width: 80px; min-height: 30px;">
                                                                ...
                                                                <div runat="server" visible='<%# Eval("CheckpointType").ToString()=="Text"?true:false %>'>
                                                                    <asp:TextBox runat="server" ID="txtValue" ClientIDMode="Static" Text='<%# Eval("ActualValue") %>' CssClass="form-control"></asp:TextBox>
                                                                </div>
