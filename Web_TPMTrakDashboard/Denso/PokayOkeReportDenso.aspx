<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PokayOkeReportDenso.aspx.cs" Inherits="Web_TPMTrakDashboard.Denso.PokayOkeReportDenso" %>
        ...
        <ContentTemplate>
            ...
            <div id="gridContainer" style="width: 100%; height: 80vh; overflow: auto">
                <asp:ListView runat="server" ID="lvChecklist" ItemPlaceholderID="itemplaceholder">
                    ...
                    <ItemTemplate>
                        <tr>
                            <td rowspan='<%# Eval("RowSpan") %>' style="display: <%# Eval("RowSpanDisplay") %>">
                                <asp:Label runat="server" ClientIDMode="Static" Visible='<%# Eval("HeaderVisibility") %>' Text="Check No."></asp:Label>
                                <asp:Label runat="server" ID="Label1" ClientIDMode="Static" Visible='<%# Eval("ContentVisibility") %>' Text='<%# Eval("SlNo") %>'></asp:Label>
                            </td>
                            <td rowspan='<%# Eval("RowSpan") %>' style="display: <%# Eval("RowSpanDisplay") %>">
                            ...
                            <td>
                                <asp:Label runat="server" ClientIDMode="Static" Visible='<%# Eval("HeaderVisibility") %>' Text="POKAYOKE Assured Item"></asp:Label>
                                <asp:Label runat="server" ID="lblPokayOkeItem" ClientIDMode="Static" Visible='<%# Eval("ContentVisibility") %>' Text='<%# Eval("PokayOkeItem") %>'></asp:Label>
                            ...
                            <td>
                                <asp:Label runat="server" ClientIDMode="Static" Visible='<%# Eval("HeaderVisibility") %>' Text="Function"></asp:Label>
                                <asp:Label runat="server" ID="lblFunction" ClientIDMode="Static" Visible='<%# Eval("ContentVisibility") %>' Text='<%# Eval("Function") %>'></asp:Label>
                            </td>
                            <td>
                                <asp:Label runat="server" ClientIDMode="Static" Visible='<%# Eval("HeaderVisibility") %>' Text="Check method"></asp:Label>
                                <asp:Label runat="server" ID="lblCheckMethod" ClientIDMode="Static" Visible='<%# Eval("ContentVisibility") %>' Text='<%# Eval("CheckMethod") %>'></asp:Label>
                            </td>
                            <td>
                                <asp:Label runat="server" ClientIDMode="Static" Visible='<%# Eval("HeaderVisibility") %>' Text="Check intrvl."></asp:Label>
                                <asp:Label runat="server" ID="lblCheckInterval" ClientIDMode="Static" Visible='<%# Eval("ContentVisibility") %>' Text='<%# Eval("CheckInterval") %>'></asp:Label>
                            </td>
                            <td style="padding: 0px; border: 0px;">
                                <asp:ListView runat="server" ID="lvChecksheetWeek" ItemPlaceholderID="itemplaceholder2" DataSource='<%# Eval("WeekList") %>'>
                                    <LayoutTemplate>
                                        ...
                                        <td class="td-actual-value">
                                            ...
                                            <div runat="server" visible='<%# Eval("ContentVisibility") %>'>
                                                ...
                                                <div runat="server" visible='<%# Eval("CheckpointType").ToString()=="Text"?true:false %>'>
                                                    <asp:TextBox runat="server" ID="txtValue" ClientIDMode="Static" Text='<%# Eval("ActualValue") %>' CssClass="form-control txt-control" ></asp:TextBox>
                                                </div>
                                                <div runat="server" visible='<%# Eval("CheckpointType").ToString()=="Yes-No"?true:false %>'>
                                                    <asp:DropDownList runat="server" ID="ddlValue" ClientIDMode="Static" CssClass="form-control" Style="width: auto">
                                                        <asp:ListItem Text="None" Value="None"></asp:ListItem>
                                                        <asp:ListItem Text="Yes" Value="Yes"></asp:ListItem>
                                                        <asp:ListItem Text="No" Value="No"></asp:ListItem>
                                                    </asp:DropDownList>
                                                </div>--%>
                                                <div runat="server" style='<%# "background-color:" + Eval("CheckpointTypeBackColor") + "; color:" + Eval("CheckpointTypeForeColor") %>' visible='<%# Eval("CheckpointType").ToString()!="Image"?true:false %>'>
