<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PokayOkeTransactionDenso.aspx.cs" Inherits="Web_TPMTrakDashboard.Denso.PokayOkeTransactionDenso" %>
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td style="padding: 0px; border: 0px;">
                                <asp:ListView runat="server" ID="lvChecksheetWeek" ItemPlaceholderID="itemplaceholder2" DataSource='<%# Eval("WeekList") %>' OnItemDataBound="lvChecksheetWeek_ItemDataBound">
                                    <LayoutTemplate>
                                        ...
                                        <td class="td-actual-value">
                                            ...
                                            <div runat="server" visible='<%# Eval("ContentVisibility") %>'>
                                                ...
                                                <div runat="server" visible='<%# Eval("CheckpointType").ToString()=="Text"?true:false %>'>
                                                    <asp:TextBox runat="server" ID="txtValue" ClientIDMode="Static" Text='<%# Eval("ActualValue") %>' CssClass="form-control txt-control" Enabled='<%# Eval("ControlEnabled") %>'></asp:TextBox>
                                                </div>
                                                <div runat="server" style='<%# "background-color:" + Eval("CheckpointTypeBackColor") + ";min-width:100px; color:" + Eval("CheckpointTypeForeColor") %>' visible='<%# Eval("CheckpointType").ToString() == "OK-NG" || Eval("CheckpointType").ToString() == "Yes-No" %>'>
