<%@ Page Title="Downtime Information" Language="C#" MasterPageFile="~/Site_Master_2.Master" AutoEventWireup="true" CodeBehind="DowntimePage.aspx.cs" Inherits="Web_TPMTrakDashboard.DowntimePage" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
  ...
  <%--  <link href="MyCssAndJS/toggel/bootstrap-toggle.min.css" rel="stylesheet" />
    ...
    <script>
        $(document).ready(function () {
            ...
            //-----------------End Toggle Condition----------------------
              ...
              $.blockUI({ message: '<img runat="server" src="~/img/loadIcon/ajax-loader.gif" />' });
            BindDownCategoryChart('DownCategory', '');
            function BindDownCategoryChart(param, type) {
                $.ajax({
                    type: "POST",
                    url: "DowntimePage.aspx/GetDownCategoryChart",
            ...
            function BindCatagory(data) {
                ...
                $("#ddlCatagory").append('<option value="0"> All Category </option>');
            ...
            BindDownCodeChart('DownCode', '','');
            function BindDownCodeChart(param, type,category) {
                $.ajax({
                    type: "POST",
                    url: "DowntimePage.aspx/GetDownCodeChart",
                    contentType: "application/json; charset=utf-8",
            ...
            function BindDynamicShiftChart(month, day, type, color, param, catagory, code) {
                $.ajax({
                    type: "POST",
                    url: "DowntimePage.aspx/GetShiftChartData",
                    contentType: "application/json; charset=utf-8",
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Shift Wise Chart</h4>
                </div>
    ...
    <div class="container">
        <div class="row text-center" style="font-size: 18px; font-weight: 900; margin-bottom: 5px;">
            <%= Session["MachineId"]%> -  Downtime Information :&nbsp&nbsp;<input type="checkbox" id="btnToggal" data-toggle="toggle" data-on="Bar Chart" data-off="Line Chart">
        </div>

        <div id="divCategoryChart"></div>
        <div style="text-align: center; padding: 5px;">
            <span style="font-size: 14px; font-weight: 900;">Filter Down Code by :</span>
            <select id="ddlCatagory" class="form-control" style="width: 200px; display: inline;" data-toggle="tooltip" title="All Category !"></select>
            <button id="btnView" class="btn btn-primary" type="button">View</button>
        </div>
