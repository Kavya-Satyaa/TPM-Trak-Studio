<%@ Page Title="Reports" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EnergyReportPage.aspx.cs" Inherits="Web_TPMTrakDashboard.EnergyModule.EnergyReportPage" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        <div class="col-md-12" style="margin: auto;">
            <h1 class="text-center login-title commontd" style="color: white;">Energy Report</h1>
                            ...
                            <ContentTemplate>
                                <table id="tblfilter" class="table table-bordered table-striped" style="margin: auto; width: auto; box-shadow: 0 6px 10px 0 rgba(0, 0, 0, 0.2), 0 8px 22px 0 rgba(0, 0, 0, 0.19); border-radius: 7px;">
                                    ...
                                    <tr id="trFromDate" runat="server">
                                        <td runat="server">
                                            <b>From Date</b> </td>
                                        <td class="input-group" runat="server" style="width: 100%">
                                            <div class="input-group-addon">
                                                <i class="glyphicon glyphicon-calendar"></i>
                                            </div>
                                            <asp:TextBox ID="txtFromDate" runat="server" CssClass="form-control date" placeholder="DD-MM-YYYY" MaxLength="15" meta:resourcekey="txtFromDateResource1" AutoCompleteType="Disabled" Style="width: auto"></asp:TextBox>
                                            <asp:TextBox ID="txtFromDateTime" runat="server" CssClass="form-control dateTime" placeholder="DD-MM-YYYY HH:mm:ss" MaxLength="15" meta:resourcekey="txtFromDateResource1" AutoCompleteType="Disabled" Style="width: auto"></asp:TextBox>
                                            <asp:TextBox ID="txtFromMonth" runat="server" CssClass="form-control month" placeholder="MMM-YYYY" MaxLength="15" meta:resourcekey="txtFromDateResource1" AutoCompleteType="Disabled" Style="width: auto"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr id="trToDate" runat="server">
                                        ...
                                        <td class="input-group" runat="server">
                                            ...
                                            <asp:TextBox ID="txtToDate" runat="server" CssClass="form-control date" placeholder="DD-MM-YYYY" MaxLength="15" AutoCompleteType="Disabled" Style="width: auto"></asp:TextBox>
                                    ...
                                    <tr id="trMachineType" runat="server">
                                        <td>
                                            <b>Machine Type</b>
                                        </td>
                                        <td>
                                            <asp:DropDownList runat="server" ID="ddlMachineType" class="form-control" OnSelectedIndexChanged="ddlMachineType_SelectedIndexChanged" AutoPostBack="true">
                                    ...
                                    <tr id="trCell" runat="server">
                                        ...
                                        <td runat="server">
                                            <asp:DropDownList ID="ddlCellID" runat="server" OnSelectedIndexChanged="ddlCellID_SelectedIndexChanged" CssClass="select form-control loadData cssclass" AutoPostBack="true"></asp:DropDownList>
                                        </td>
                                    </tr>
                                    ...
                                    <tr id="trTopEnergyConsumption" runat="server">
                                        <td runat="server">
                                            <b>Top 10 machines by
                                                <br />
                                                energy consumption.</b>
                                        </td>
                                        <td runat="server">
                                            <asp:CheckBox runat="server" ID="chkTopEnergyConsumption" ClientIDMode="Static" />
                                        </td>
                                    </tr>
                                    <tr>
