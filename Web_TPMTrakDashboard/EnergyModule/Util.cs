...
namespace Web_TPMTrakDashboard.EnergyModule
{
    public class Util
    {
        static string appPath = HttpContext.Current.Server.MapPath("~/EnergyModule/Reports");
        static string[] formats = new string[] { "dd-MM-yyyy HH:mm:ss", "dd-MM-yyyy HH:mm", "dd-MM-yyyy", "dd-MMM-yyyy", "dd-MMM-yyyy HH:mm", "dd-MMM-yyyy HH:mm:ss", "yyyy-MM-dd", "yyyy-MM-dd HH:mm:ss", "dd-MM-yyyyTHH:mm:ss", "dd-MM-yyyyTHH:mm", "dd-MMM-yyyyTHH:mm", "dd-MMM-yyyyTHH:mm:ss", "yyyy-MM-ddTHH:mm:ss", "yyyy-MM-ddTHH:mm", "MM/dd/yyyy hh:mm:ss tt",  "MM/dd/yyyy h:mm:ss tt" , "MM/d/yyyy hh:mm:ss tt" , "M/dd/yyyy hh:mm:ss tt", "MM/d/yyyy h:mm:ss tt", "M/dd/yyyy h:mm:ss tt", "MM/dd/yyyy hh:mm:ss", "MM/dd/yyyy h:mm:ss",
        "MM/d/yyyy hh:mm:ss", "M/dd/yyyy hh:mm:ss", "MM/d/yyyy h:mm:ss", "M/dd/yyyy h:mm:ss", "M/d/yyyy h:mm:ss tt", "M/d/yyyy h:mm:ss"  };
