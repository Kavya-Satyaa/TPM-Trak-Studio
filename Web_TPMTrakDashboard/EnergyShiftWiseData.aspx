<%@ Page Language="C#" Title="ShiftWise Energy   Data" MasterPageFile="~/Site_Master_2.Master" AutoEventWireup="true" CodeBehind="EnergyShiftWiseData.aspx.cs" Inherits="Web_TPMTrakDashboard.EnergyShiftWiseData" meta:resourcekey="PageResource1" Culture="auto" UICulture="auto" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container">
        <div class="row text-center" style="font-size: 18px; font-weight: 900; color: white">
            <asp:Label runat="server" ID="lblTitle" Text='<%=GetLocalResourceObject("ShiftwiseEnergyData") %>' meta:resourcekey="lblTitleResource1"></asp:Label>
            <br />
    ...
    <div style='font-family: Calibri; font-style: normal; font-weight: 700; margin-right: 20px; margin-left: 20px;'>
        <div style="max-height: 440px; overflow-y: auto; margin-top: 5px;" class="headerFixer">
            <asp:GridView ID="gridViewEnergyShiftWiseData" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered" ShowHeaderWhenEmpty="True" EmptyDataText="<%$ Resources:CommanResource, Nodataavailable %>" HorizontalAlign="Center" meta:resourcekey="gridViewEnergyShiftWiseDataResource1" HeaderStyle-BackColor="#5391CA" HeaderStyle-ForeColor="White" HeaderStyle-Font-Bold="true" HeaderStyle-Font-Size="Large" RowStyle-BackColor="#BACADE" AlternatingRowStyle-BackColor="#DCE7F5" RowStyle-Font-Size="Medium" RowStyle-ForeColor="#383838" RowStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" OnRowDataBound="gridViewEnergyShiftWiseData_RowDataBound" >
                <AlternatingRowStyle BackColor="#DCE7F5" />
                <Columns>
                    <asp:BoundField HeaderText="Date" DataField="StartTime" meta:resourcekey="BoundFieldResource1" DataFormatString="{0:dd-MMM-yyyy}" />
                    <%--<asp:HyperLinkField HeaderText="Shift" DataNavigateUrlFields="ShiftName" DataTextField="ShiftName" Target="_blank" meta:resourcekey="BoundFieldResource4" />--%>
                    <asp:BoundField HeaderText="Shift" DataField="ShiftName" meta:resourcekey="BoundFieldResource14" />
        ...
        <div style='font-family: Calibri; font-style: normal; font-weight: 700; margin-top: 5px;'>
            <div id="ShiftwiseEnergyChart" style="width: 100%;" />
        </div>
    </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            GetShiftwiseEnergyChartData();
        });

        var ShiftwiseEnergyData = {};
        function GetShiftwiseEnergyChartData() {
            showLoader();
            var param = "Shift";
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "EnergyShiftWiseData.aspx/GetShiftwiseEnergyChartData",
                data: '{param:"' + param + '"}',
                dataType: "json",
                success: function (result) {
                    ShiftwiseEnergyData = result.d;
                    PlotShiftwiseEnergyChart(ShiftwiseEnergyData);
                },
        ...
        function PlotShiftwiseEnergyChart(energyData) {
            chart = Highcharts.chart('ShiftwiseEnergyChart', {
                chart: {
                    type: 'column'
                },
                title: {
                    text: 'Shiftwise Energy Data'
                },
                subtitle: {
                    text: ''
                },
