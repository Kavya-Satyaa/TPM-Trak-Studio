<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AndonSetting.aspx.cs" Inherits="Web_TPMTrakDashboard.GEA.Andon_GEA.AndonSetting" %>
...
<body>
    <form id="form1" runat="server">
        <div class=" container-fluid">
            ...
            <div>
                <div class="" style="width: 80%; margin: auto">
                    <div style="border: 2px solid  #3777bc; margin-top: 30px; box-shadow: 2px 2px 8px 2px #efe7e7; padding: 10px;">
                        <div class="row">
                            <div class="col-lg-6">
                            ...
                            <asp:CheckBoxList runat="server" ID="chkListviewColumns" ClientIDMode="Static" CssClass="chkTbl">
                                    ...
                                    <asp:CheckBoxList runat="server" ID="chkListviewColumns2" ClientIDMode="Static" CssClass="chkTbl">
                                       ...
                                       <%-- <tr>
                                         ...
                                         <tr>
                                            <td class="sideHeader">Image/Video Flip Interval (ss)</td>
                                            <td>
                                                <asp:TextBox runat="server" ID="txtImageVideoFlipInterval" AutoCompleteType="Disabled" CssClass="form-control showToastr" ClientIDMode="Static" onkeypress="return allowNumberic(event);"></asp:TextBox>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <i class="glyphicon glyphicon-list-alt" title="Delete" style="color: #a20909; font-size: 20px;" onclick="showImageList();"></i>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <i class="glyphicon glyphicon-list-alt" title="Delete" style="color: #a20909; font-size: 20px;" onclick="showVideoList();"></i>
                                            </td>
                                        </tr>
                                        <%--  <tr>
                                        ...
                                        <tr>
                                            <td class="sideHeader">Data for Production</td>
                                            <td>
                                                <asp:DropDownList runat="server" ID="ddlDailyWeekly" CssClass="form-control showToastr">
                                                    <asp:ListItem Text="Day Wise" Value="Daywise"></asp:ListItem>
                                                    <asp:ListItem Text="Week Wise" Value="Weekwise"></asp:ListItem>
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="sideHeader">Data for Decanter</td>
                                            <td>
                                                <asp:DropDownList runat="server" ID="ddlShiftDayType" CssClass="form-control showToastr">
                                ...
                                <fieldset class="masterFS">
                                    <legend>&nbsp;<b>Screen to show on Andon</b></legend>
                                    <table>
                                        <tr>
                                            <td class="sideHeader" style="width: 500px">Production with Leading and Lagging Machines</td>
                                            <td>
                                                <asp:CheckBox runat="server" ID="chkPOWithLeadLag" ClientIDMode="Static" Style="font-size: 17px;" CssClass="showToastr" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="sideHeader" style="width: 500px">Production with Charts</td>
                                            <td>
                                                <asp:CheckBox runat="server" ID="chkPOWithCharts" ClientIDMode="Static" Style="font-size: 17px;" CssClass="showToastr" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="sideHeader" style="width: 500px">Decanter and Machine Shop Output</td>
                                            <td>
                                                <asp:CheckBox runat="server" ID="chkDecanterMachine" ClientIDMode="Static" Style="font-size: 17px;" CssClass="showToastr" />
                                            </td>
                                        </tr>
                                    </table>
                                </fieldset>
                            ...
                            <div class="col-lg-6">
                                ...
                                <fieldset class="masterFS">
                                    <legend>&nbsp;<b>Scrolling Text</b> </legend>
                                    <asp:TextBox runat="server" ID="txtScrolling" TextMode="MultiLine" ClientIDMode="Static" CssClass="form-control showToastr" AutoCompleteType="Disabled" Style="width:100%;max-width:unset;height:150px"></asp:TextBox>
                                </fieldset>
                            </div>
                        </div>
            ...
            <div class="modal-dialog modal-dialog-centered" style="width: 70%">
                <div class="modal-content" style="border: 2px solid #3777bc">
                    ...
                    <div class="modal-footer" style="padding: 5px; border-top: 1px solid #3777bc; text-align: center">
                        <input type="button" value="Save" class="btn btn-info" style="background-color: #3777bc; color: white" onclick="imgVideoSave('image');" />
        ...
        <div class="modal fade" id="showAllVideos" role="dialog">
            <div class="modal-dialog modal-dialog-centered" style="width: 70%">
                <div class="modal-content" style="border: 2px solid #3777bc">
                    ...
                    <div class="modal-footer" style="padding: 5px; border-top: 1px solid #3777bc; text-align: center">
                        <input type="button" value="Save" class="btn btn-info" style="background-color: #3777bc; color: white" onclick="imgVideoSave('video');" />
        ...
        <script>
            ...
            function getSavePopUpValue() {
                $.ajax({
                    async: false,
                    type: "POST",
                    url: "AndonSetting.aspx/getSavePopUpValueFromSession",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (response) {
                        var result = response.d;
                        if (result == "1") {
                            showpop5('Items are saved successfully', '');
                        }
                        else if (result == "0") {
                            showpop5('Failed', '');
                        }
            ...
            function imgVideoSave(param) {
                debugger;
                var divs;
                if (param == "image") {
                    divs = $('#ImageList .imageVideoDiv');
                }
                else if (param == "video") {
                    divs = $('#VideoList .imageVideoDiv');
                }
                for (var i = 0; i < divs.length; i++) {
                    var name = "";
                    var sortOrder = "0";
                    if (param == "image") {
                        name = $(divs[i]).find('img').attr("alt");

                    }
                    else {
                        name = $(divs[i]).find('video').attr("alt");
                    }
                    var spliData = name.split("/");
                    name = spliData[spliData.length - 1];
                    sortOrder = $(divs[i]).find(".txtSortOrder").val();
                    $.ajax({
                        async: false,
                        type: "POST",
                        url: "AndonSetting.aspx/saveImageVideoSortOrder",
                        contentType: "application/json; charset=utf-8",
                        data: '{name:"' + name + '",order:"' + sortOrder + '"}',
                        dataType: "json",
                        success: function (response) {
                            var result = response.d;
            ...
            function dataValidation() {
                ...
                if ($('#chkShowImage').prop('checked') == true || $('#chkShowVideo').prop('checked') == true) {
                    ...
                    //    return false;
                    //}
                    if ($('#txtImageVideoFlipInterval').val().trim() == "") {
                        openWarningModal('Please enter Image/Video Flip Interval.');
                        return false;
                    }
                }
                return true;
            ...
            function imageDeleteBtnClick() {
                var chkBox = $('#ImageList input.chkImageDelete');
                var flag = 0;
            ...
            function videoDeleteBtnClick() {
                var chkBox = $('#VideoList input.chkImageDelete');
                var flag = 0;
                for (var i = 0; i < chkBox.length; i++) {
                    if (chkBox[i].checked) {
                        flag = 1;
            ...
            function deleteVideoClick() {
                ...
                if (video.length > 0) {
                    ...
                    for (var i = 0; i < chkBox.length; i++) {
                        if (chkBox[i].checked) {
                            deletedVideo.push(video[i].getAttribute('alt').split('/').pop());
                        }
                    }
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if (itmdata.length > 0) {
                            ...
                            var appendString = "";
                            for (var i = 0; i < itmdata.length; i++) {
                                appendString += '<div class="imageVideoDiv"><img src="' + itmdata[i].Parameter + '" alt="' + itmdata[i].Parameter + '" class="imagelist" /><input type="checkbox" class="chkImageDelete" /><div style="margin-top:10px"><input type="input" class="txtSortOrder form-control" value="' + itmdata[i].ValueInInt + '" /></div></div>';
                            }
                            $('#ImageList').append(appendString);
                        }
                    },
                    ...
                    success: function (response) {
                        ...
                        if (itmdata.length > 0) {
                            ...
                            for (var i = 0; i < itmdata.length; i++) {
                                ...
                                appendString += '<div class="imageVideoDiv"><video class="slide-image embed-responsive-item center-block makeStyle" alt="' + itmdata[i].Parameter + '" playsinline="playsinline" muted="muted" autoplay="autoplay" controls><source src="' + itmdata[i].Parameter + '" /></video><input type="checkbox" class="chkImageDelete" /><div style="margin-top:10px"><input type="input" class="txtSortOrder form-control" value="' + itmdata[i].ValueInInt + '" /></div></div>';
            ...
            $('#txtRefreshInterval').blur(function () {
                ...
                if ($('#txtRefreshInterval').val() != "") {
                    ...
                    if (refreshInterval < 30) {
                        ...
                        openWarningModal("Minimum value of Enable Slide Show Interval should be 30.");
                        return;
                    }
                }
            ...
            $('#txtImageVideoFlipInterval').blur(function () {
                var flipInterval;
                if ($('#txtImageVideoFlipInterval').val() != "") {
                    flipInterval = parseInt($('#txtImageVideoFlipInterval').val());
                    if (flipInterval < 5) {
                        $('#txtImageVideoFlipInterval').val("");
                        openWarningModal("Image/Video Flip Interval should be greater than 5 Sec.");
                        return;
                    }
                }
            });
