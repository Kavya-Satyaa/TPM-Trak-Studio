<%@ Page Title="Quality Incoming Master" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" Culture="auto" UICulture="auto" CodeBehind="QualityIncomingMaster.aspx.cs" Inherits="Web_TPMTrakDashboard.GEA.QualityIncomingMaster" EnableEventValidation="false" Async="true" AsyncTimeout="120000" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <asp:UpdatePanel ID="UpdatePanelMain" runat="server">
            <ContentTemplate>
                ...
                <div class="row" style="height: 60px;">
                    <table id="tblFilter" class="table table-bordered">
                        <tr>
                            ...
                            <td class="commanTd" style="width: 104px; height: 40px; vertical-align: middle;"><%=GetGlobalResourceObject("CommanResource","OperationNo") %></td>
                            ...
                            <td style="width: 120px;">
                                <asp:Button runat="server" CssClass="btn btn-primary btnStyle" ID="btnView" Text="View" Style="min-width: 120px;" OnClick="btnView_ClickAsync" />
                            </td>
                            <td>
                ...
                <div style="overflow-x: auto; overflow-y: auto; height: 70vh">
                    <asp:GridView ID="GridQualityIncomingMaster" runat="server" AutoGenerateColumns="false" CssClass="table table-bordered headerFixerhere" RowStyle-BackColor="#BACADE" AlternatingRowStyle-BackColor="#DCE7F5" RowStyle-Font-Size="Medium" RowStyle-ForeColor="#383838" RowStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" ShowHeaderWhenEmpty="true" OnRowDataBound="GridQualityIncomingMaster_RowDataBound">
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="IDD" SortExpression="ID" Visible="false">
                                <ItemTemplate>
                                    <asp:Label ID="lblIDD" runat="server" Text='<%#Bind("ID") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>

                            <asp:TemplateField HeaderText="Ins. Param ID" SortExpression="CharacteristicID" ControlStyle-Width="150">
                                <ItemTemplate>
                                    <asp:TextBox ID="txtInsParamID" runat="server" CssClass="form-control" Text='<%#Bind("CharacteristicID") %>'></asp:TextBox>
                                </ItemTemplate>
                            </asp:TemplateField>

                            <asp:TemplateField HeaderText="Ins. Param Name" SortExpression="CharacteristicCode">
                                <ItemTemplate>
                                    <asp:TextBox ID="txtInsParameter" runat="server" CssClass="form-control" Text='<%#Bind("CharacteristicCode") %>'></asp:TextBox>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Set Value" SortExpression="SetValue" ControlStyle-Width="120">
                                <ItemTemplate>
                                    <asp:TextBox ID="txtSetValue" runat="server" CssClass="form-control" Text='<%#Bind("SetValue") %>'></asp:TextBox>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Data Type" SortExpression="DataType" ControlStyle-Width="130">
                                <ItemTemplate>
                                    <asp:DropDownList ID="ddlDataType" runat="server" SelectedValue='<%#Bind("DataType") %>' CssClass="form-control">
                            ...
                            <asp:TemplateField HeaderText="Is Mandatory" ControlStyle-Width="150">
                                <ItemTemplate>
                                    <asp:CheckBox ID="chkIsMandatory" runat="server" Checked='<%#Bind("IsMandatory") %>' CssClass="form-control" />
                                </ItemTemplate>
                            </asp:TemplateField>

                            <asp:TemplateField HeaderText="Is Enabled" ControlStyle-Width="120">
                                <ItemTemplate>
                                    <asp:CheckBox ID="chkIsEnabled" runat="server" Checked='<%#Bind("IsEnabled") %>' CssClass="form-control" />
                                </ItemTemplate>
                            </asp:TemplateField>

                              <asp:TemplateField HeaderText="Sequence" ControlStyle-Width="100">
                                <ItemTemplate>
                                    <asp:TextBox ID="txtSequence" runat="server" CssClass="form-control" Text='<%#Bind("Sequence") %>'></asp:TextBox>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                ...
                <div class="DataOperations">
                    <asp:FileUpload data-toggle="tooltip" ForeColor="Black" CssClass="form-control btnStyle" ID="FileUploadQualityMaster" runat="server" ClientIDMode="Static" AllowMultiple="false" Style="display: inline; width: 220px;" />
                    <button type="button" id="btnImportQualityMaster" class="btn btn-primary btnStyle" style="display: inline;">Import</button>
                    ...
                    <asp:Button runat="server" ID="btnCancel" Text="Cancel" CssClass="btn btn-primary btnStyle" OnClick="btnCancel_ClickAsync" ClientIDMode="Static" Style="display: inline;" />
                    <asp:Button runat="server" ID="btnDelete" Text="Delete" CssClass="btn btn-primary btnStyle" OnClick="btnDelete_ClickAsync" ClientIDMode="Static" Style="display: inline;" />
                    <asp:Button runat="server" ID="btnSave" Text="Save" CssClass="btn btn-primary btnStyle SaveClick" OnClick="btnSave_ClickAsync" ClientIDMode="Static" Style="display: inline;" />
                </div>
            </ContentTemplate>
        </asp:UpdatePanel>
    </div>
    ...
    <div id="MessagePopup" class="modal fade" role="dialog">
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" runat="server" class="btn btn-success" data-dismiss="modal" onserverclick="btnSave2_ClickAsync" id="btnsavedata" value="submit">Save</button>
    ...
    <div id="QualityMasterImportPopup" class="modal fade" role="dialog">
        <div class="modal-dialog">
            <!-- Modal content-->
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-footer">
                    <asp:Button runat="server" ID="btnImportData" Text="Import" CssClass="btn btn-primary" OnClick="btnImportData_ClickAsync"></asp:Button>
                    <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
                </div>
            </div>
        </div>
    ...
    <script type="text/javascript">
        ...
        $("#btnDownloadTemplate").click(function () {
            ...
            if (document.URL) {
                ...
                downloadUrl = Url.slice(0, Url.lastIndexOf('/')) + '/QualityIncomingMasterTemplate.xlsx';
                if (downloadUrl) {
        ...
        //    debugger;
        //});
        $("#btnImportQualityMaster").click(function () {
            debugger;
            var dd = $("#FileUploadQualityMaster")[0].files.length;
            if (dd == 0) {
                var title = "Import Quality Incoming Master";
                ...
                var filename = $("#FileUploadQualityMaster")[0].files[0].name;
                if (filename !== null && filename !== undefined) {
                    ...
                    if (file_extension !== null && file_extension !== undefined) {
                        if (file_extension !== "xlsx") {
                            ...
                            $("#QualityMasterImportPopup .modal-title").html(title);
                            $("#QualityMasterImportPopup").modal("show");
                            return true;
                        }
                    }
                    else {
        ...
        $("#btnDelete").click(function () {
            var chkCount = 0;
            $("#MainContent_GridQualityIncomingMaster tr").not(':first').each(function () {
                var this_row = $(this);
            ...
            if (chkCount > 0) {
                ...
                var title = "Delete Quality Incoming Master";
