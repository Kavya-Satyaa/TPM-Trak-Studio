<%@ Page Language="C#" Title="Weekly Checklis Report" AutoEventWireup="true" MasterPageFile="~/Site.Master" Culture="auto" UICulture="auto" CodeBehind="WeeklyChecklistReport.aspx.cs" Inherits="Web_TPMTrakDashboard.GEA.WeeklyChecklistReport" %>
    ...
    <div class="container-fluid" style="margin-left: 5px;">
        <asp:UpdatePanel ID="UpdatePanelMaintChklistReport" runat="server">
            ...
            <ContentTemplate>
                ...
                <div style="overflow-x: auto; overflow-y: auto;height:80vh;" id="gridContainer">
                    <asp:GridView ID="GridMaintTransactionReport" runat="server" CssClass="table table-bordered headerFixerhere" RowStyle-BackColor="#BACADE" AlternatingRowStyle-BackColor="#DCE7F5" RowStyle-Font-Size="Medium" RowStyle-ForeColor="#383838" RowStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" ShowHeaderWhenEmpty="false" AutoGenerateColumns="false" Height="100%" OnDataBound="GridMaintTransactionReport_DataBound">
