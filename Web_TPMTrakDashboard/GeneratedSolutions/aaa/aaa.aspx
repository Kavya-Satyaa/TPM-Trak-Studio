<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="aaa.aspx.cs" Inherits="Web_TPMTrakDashboard.aaa" %>
<!DOCTYPE html>
<html>
<head runat="server">
    <title>bbb</title>
            ...
            <ContentTemplate>
                ...
                <div id="pnlDate" runat="server" class="dropdown-container">
                    ...
                    <asp:TextBox ID="txtDate" runat="server" TextMode="Date" CssClass="dropdown-control" />
                        ...
                        <asp:Button ID="btnExport" runat="server" Text="Export to Excel" CssClass="btn-view" style="background: #10b981; margin-left:10px;" OnClick="btnExport_Click" />
