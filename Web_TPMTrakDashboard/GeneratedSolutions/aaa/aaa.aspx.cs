...
namespace Web_TPMTrakDashboard
{
    public partial class aaa : System.Web.UI.Page
    {
        ...
        private void CreateDynamicColumns()
        {
            if (gvReport.Columns.Count == 0)
            {
                ...
                templateCol3.ItemTemplate = new DynamicTemplate_aaa("Status", "Checkbox");
                gvReport.Columns.Add(templateCol3);
                var templateCol4 = new TemplateField();
                templateCol4.HeaderText = "Value";
                templateCol4.ItemTemplate = new DynamicTemplate_aaa("Value", "TextField");
                gvReport.Columns.Add(templateCol4);
                var actionCol = new TemplateField();
                actionCol.HeaderText = "Action";
                actionCol.ItemTemplate = new DynamicTemplate_aaa("Action", "DeleteButton");
    ...
    public class DynamicTemplate_aaa : ITemplate
    {
        private string _colName; private string _type;
        public DynamicTemplate_aaa(string colName, string type) { _colName = colName; _type = type; }
