<%@ Page Title="" Language="C#" MasterPageFile="~/Site_Master_2.Master" AutoEventWireup="true" CodeBehind="HourDefinitionPage.aspx.cs" Inherits="Web_TPMTrakDashboard.HourDefinitionPage" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
                    ...
                    <table class="table table-bordered" style="width: 75%">
                        <tr>
                            ...
                            <td rowspan="2" style="vertical-align: middle; text-align: center">
                                ...
                                <asp:DropDownList ID="ddlShiftId" runat="server" CssClass="form-control" Width="140px" AutoPostBack="true" OnSelectedIndexChanged="ddlShiftId_SelectedIndexChanged" Style="display: inline"></asp:DropDownList></td>

                            <td style="vertical-align: middle" class="commontd">From</td>
                            <td>
                                <asp:TextBox ID="txtFromDay" runat="server" CssClass="form-control" Style="display: inline; width: 115px;" ReadOnly="true"></asp:TextBox>&nbsp;&nbsp;<asp:TextBox ID="txtFromTime" runat="server" CssClass="form-control" Style="display: inline; width: 115px;" ReadOnly="true"></asp:TextBox></td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtToDay" runat="server" CssClass="form-control" Style="display: inline; width: 115px;" ReadOnly="true"></asp:TextBox>&nbsp;&nbsp;<asp:TextBox ID="txtToTime" runat="server" CssClass="form-control" Style="display: inline; width: 115px;" ReadOnly="true"></asp:TextBox></td>
                        </tr>
                        <tr>
                    ...
                    <asp:GridView ID="gridviewHourly" runat="server" CssClass="table table-bordered" AutoGenerateColumns="false" Width="75%">
                        <Columns>
                            ...
                            <%--<asp:TemplateField HeaderText="From Time">
                                <ItemTemplate>
                                    <asp:Label ID="lblHourStart" runat="server" Text='<%# Eval("HourStart","{0:hh:mm:ss tt}") %>' Width="120px"></asp:Label>
                                </ItemTemplate>
                            ...
                            <%--<asp:TemplateField HeaderText="To Time">
                                <ItemTemplate>
                                    <asp:Label ID="lblHourEnd" runat="server" Text='<%# Eval("HourEnd","{0:hh:mm:ss tt}") %>' Width="120px"></asp:Label>
                                </ItemTemplate>
                                <ItemStyle Width="120px" />
                            </asp:TemplateField>--%>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            //$("#MainContent_gridviewHourly .numberValue").change(function () {
            //    
            //    let minValue = $(this).val();
            //    if (minValue != "") {
            //        if (parseInt(minValue) > 60) alert("Hour minutes cannot exceed from 60 min");
            //        else if (parseInt(minValue) == 00) alert("Hour minutes cannot be Zero");
            //        else if (parseInt(minValue) < 60) {
            //            $(this).trigger("change");
            //            $(this).closest('td').find('input .numberValue').trigger("change");
            //        }
            //    } else alert("Hour minutes cannot be empty");
            //    return false;
            //});
