<%@ Page Title="Down Time Matrix Info" Trace="false" AsyncTimeout="6000" Async="true" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MachineDownReasonTimeMatrixAgg.aspx.cs" Inherits="Web_TPMTrakDashboard.MachineDownReasonTimeMatrixAgg"   %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
            ...
            <table class="table table-bordered" id="tblfilter">
                ...
                <tr>
                    ...
                    <td class="input-group" style="padding-bottom: 10px; padding-top: 10px;">
                        ...
                        <asp:TextBox ID="txtFromDate" runat="server" Style="width: 160px; height: 42px" CssClass="form-control date1" placeholder="From Date" AutoCompleteType="Disabled" meta:resourcekey="txtFromDateResource1"></asp:TextBox>
                    </td>
                    ...
                    <td class="input-group" style="padding-bottom: 10px; padding-top: 10px;">
                        ...
                        <asp:TextBox ID="txtToDate" Style="width: 160px; height: 42px;" runat="server" CssClass="form-control date2" placeholder="To Date" AutoCompleteType="Disabled" meta:resourcekey="txtToDateResource1"></asp:TextBox>
                    </td>
                    <td class="commontd">
                    ...
                    <td colspan="2" style="text-align: left">
                        <label class="checkbox" style="display: none; margin-left: 15px; color: white">
                            <asp:CheckBox ID="chkExclude" runat="server" meta:resourcekey="chkExcludeResource1" /><%=GetLocalResourceObject("Exclude")%>
                        </label>
                        <asp:Button runat="server" Text="<%$ Resources:CommanResource, Process %>" class="btn btn-info btn-sm" ID="btnProcess" OnClick="btnProcess_Click" Style="margin-left: 15px;" OnClientClick="return processValidation();" meta:resourcekey="btnProcessResource1"></asp:Button>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            //        url: "MachineDownReasonTimeMatrixAgg.aspx/GetCellIdData",
            //        data: '{PlantId:"' + value + '"}',
            //        dataType: "json",
            ...
            //        type: "POST",
            //        contentType: "application/json; charset=utf-8",
            //        url: "MachineDownReasonTimeMatrixAgg.aspx/GetMachineIdData",
     ...
     <%--   $(document).on("click", "[id$=btnProcess]", function () {
        ...
        function GetFirstDownTimeData() {
            $.ajax({
                type: "POST",
                url: "MachineDownReasonTimeMatrixAgg.aspx/MCsbyTopDownsChart",
                contentType: "application/json; charset=utf-8",
        ...
        function GetSecondDownTimeData() {
            $.ajax({
                type: "POST",
                url: "MachineDownReasonTimeMatrixAgg.aspx/TopDownbyMCChart",
                contentType: "application/json; charset=utf-8",
                data: '{plantID:"' + $("[id$=ddlPlantId]").val() + '",machineId:"' + $("[id$=ddlMachineId]").val() + '",startFromDate:"' + $("[id$=txtFromDate]").val() + '",startToDate:"' + $("[id$=txtToDate]").val() + '",downID:"' + $("[id$=ddlMultiDownID]").val() + '",exclude:"' + $("[id$=chkExclude]").prop('checked') + '",downReasons:"' + $("[id$=ddlTopDownReasons]").val() + '",CellID:"' + $("[id$=ddlCellID]").val() + '"}',
                dataType: "json",
        ...
        function GetFirstDownFreqData() {
            $.ajax({
                type: "POST",
                url: "MachineDownReasonTimeMatrixAgg.aspx/MCsbyTopDownFreqChart",
                contentType: "application/json; charset=utf-8",
                data: '{plantID:"' + $("[id$=ddlPlantId]").val() + '",machineId:"' + $("[id$=ddlMachineId]").val() + '",startFromDate:"' + $("[id$=txtFromDate]").val() + '",startToDate:"' + $("[id$=txtToDate]").val() + '",downID:"' + $("[id$=ddlMultiDownID]").val() + '",exclude:"' + $("[id$=chkExclude]").prop('checked') + '",downReasons:"' + $("[id$=ddlTopDownReasons]").val() + '",CellID:"' + $("[id$=ddlCellID]").val() + '"}',
                dataType: "json",
        ...
        function GetSecondDownFreqData() {
            $.ajax({
                type: "POST",
                url: "MachineDownReasonTimeMatrixAgg.aspx/TopDownFreqbyMCsChart",
                contentType: "application/json; charset=utf-8",
                data: '{plantID:"' + $("[id$=ddlPlantId]").val() + '",machineId:"' + $("[id$=ddlMachineId]").val() + '",startFromDate:"' + $("[id$=txtFromDate]").val() + '",startToDate:"' + $("[id$=txtToDate]").val() + '",downID:"' + $("[id$=ddlMultiDownID]").val() + '",exclude:"' + $("[id$=chkExclude]").prop('checked') + '",downReasons:"' + $("[id$=ddlTopDownReasons]").val() + '",CellID:"' + $("[id$=ddlCellID]").val() + '"}',
                dataType: "json",
        ...
        function GetDownTimeParetoData() {
            $.ajax({
                type: "POST",
                url: "MachineDownReasonTimeMatrixAgg.aspx/TopDownTimeParetoChartColAndPie",
                contentType: "application/json; charset=utf-8",
                data: '{plantID:"' + $("[id$=ddlPlantId]").val() + '",machineId:"' + $("[id$=ddlMachineId]").val() + '",startFromDate:"' + $("[id$=txtFromDate]").val() + '",startToDate:"' + $("[id$=txtToDate]").val() + '",downID:"' + $("[id$=ddlMultiDownID]").val() + '",exclude:"' + $("[id$=chkExclude]").prop('checked') + '",downReasons:"' + $("[id$=ddlTopDownReasons]").val() + '",CellID:"' + $("[id$=ddlCellID]").val() + '"}',
                dataType: "json",
        ...
        function GetCatagoryDownTimeParetoData() {
            $.ajax({
                type: "POST",
                url: "MachineDownReasonTimeMatrixAgg.aspx/CatagoryByDownTimeParetoChart",
                contentType: "application/json; charset=utf-8",
                data: '{plantID:"' + $("[id$=ddlPlantId]").val() + '",machineId:"' + $("[id$=ddlMachineId]").val() + '",startFromDate:"' + $("[id$=txtFromDate]").val() + '",startToDate:"' + $("[id$=txtToDate]").val() + '",downID:"' + $("[id$=ddlMultiDownID]").val() + '",exclude:"' + $("[id$=chkExclude]").prop('checked') + '",downReasons:"' + $("[id$=ddlTopDownReasons]").val() + '",CellID:"' + $("[id$=ddlCellID]").val() + '"}',
                dataType: "json",
