...
{
    public partial class MachineDownReasonTimeMatrixAgg : System.Web.UI.Page
    {
        ...
        private async Task GetAsync()
        {
            try
            {
                ...
                var vardownTime = TMPTrakDataBase.GetDownTimeAndFreqDataAggregate(fromDate, toDate, machineSelection, plantId, downId, Exclude, "DTime", cellId);
                var vardownTimeFreq = TMPTrakDataBase.GetDownTimeAndFreqDataAggregate(fromDate, toDate, machineSelection, plantId, downId, Exclude, "DFreq", cellId);
        ...
        private void BindTimeWiseInfo()
        {
            try
            {
                ...
                DataTable dt = TMPTrakDataBase.MachineDownTimeMatrix(fromDate, toDate, machineSelection, plantId, downId, Exclude, "DTime", cellId, "s_GetSONA_ShiftAgg_DowntimeMatrix", "");
                Session["DownTime"] = dt;
        ...
        private void BindDownTimeFreqWise()
        {
            try
            {
                ...
                DataTable dt = TMPTrakDataBase.MachineDownTimeMatrix(fromDate, toDate, machineSelection, plantId, downId, Exclude, "DFreq", cellId, "s_GetSONA_ShiftAgg_DowntimeMatrix", "");
        ...
        public static ChartData<SeriesTimeWise> MCsbyTopDownsChart(string plantID, string machineId, string startFromDate, string startToDate, string downID, bool exclude, int downReasons, string CellID)
        {
            ...
            try
            {
                ...
                if (HttpContext.Current.Session["DownTime"] == null)
                    dt = TMPTrakDataBase.MachineDownTimeMatrix(fromDate, toDate, machineId, plantId, downId, Exclude, "DTime", CellID, "s_GetSONA_ShiftAgg_DowntimeMatrix", "");
                else
        ...
        public static ChartData<SeriesTimeWise> MCsbyTopDownFreqChart(string plantID, string machineId, string startFromDate, string startToDate, string downID, bool exclude, int downReasons, string CellID)
        {
            ...
            try
            {
                ...
                if (HttpContext.Current.Session["DownTimeFreq"] == null)
                    dt = TMPTrakDataBase.MachineDownTimeMatrix(fromDate, toDate, machineId, plantId, downId, Exclude, "DFreq", CellID, "s_GetSONA_ShiftAgg_DowntimeMatrix", "");
                else
        ...
        public static Chart<DrildownData> TopDownTimeParetoChart(string plantID, string machineId, string startFromDate, string startToDate, string downID, bool exclude, int downReasons, string CellID)
        {
            ...
            try
            {
                ...
                if (HttpContext.Current.Session["DownParetoData"] == null)
                    HttpContext.Current.Session["DownParetoData"] = dt = TMPTrakDataBase.MachineDownTimeMatrix(fromDate, toDate, machineId, plantId, downId, Exclude, "DLoss_By_Catagory", CellID, "s_GetSONA_ShiftAgg_DowntimeMatrix", "");
                else
        ...
        public static Chart<Series> CatagoryByDownTimeParetoChart(string plantID, string machineId, string startFromDate, string startToDate, string downID, bool exclude, int downReasons, string CellID)
        {
            ...
            try
            {
                ...
                chart.series.Add(new Series
                {
                    name = HttpContext.GetLocalResourceObject("~/MachineDownReasonTimeMatrixAgg.aspx", "Category").ToString() == null ? "Category" : HttpContext.GetLocalResourceObject("~/MachineDownReasonTimeMatrixAgg.aspx", "Category").ToString(),
                    type = "column",
                    colorByPoint = true,
                    zIndex = 2,
                    data = new List<Data>()
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string Generated = TPMTrakGenerateReportNewDll.MachineDownTimeMatrix(Util.GetDateTime(txtFromDate.Text), ddlPlantId.SelectedValue.ToString(), machineId, Util.GetDateTime(txtToDate.Text), downId, Exclude, TheBrowserWidth, TheBrowserHeight, ddlTopDownReasons.SelectedValue, "", "aggregate", "TimeAndFreqWise");
