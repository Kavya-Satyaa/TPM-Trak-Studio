<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" ValidateRequest="false" EnableEventValidation="false" CodeBehind="ModifiedData.aspx.cs" Inherits="Web_TPMTrakDashboard.ModifiedData" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:UpdatePanel ID="updatePanal1" runat="server">
        <ContentTemplate>
            ...
            <asp:HiddenField runat="server" ID="hdnShowWorkOrderNo" ClientIDMode="Static" />
            <div class="row">
                        ...
                        <div id="grpoption">
                            <fieldset class="scheduler-border" id="updatabox" style="width: 71%; height: 135px; display: inline-block; min-width: 71%">
                                ...
                                <ul class="nav nav-pills" style="margin-top: -20px; white-space: nowrap; overflow: auto" id="tabsContainer">
                                    ...
                                    <%--   <li><a class="menuData" data-toggle="tab" href="#inconsistency">View Data Inconsistency</a></li>--%>
                                </ul>
                                            ...
                                            <div>
                                                <table class="table table-bordered" style="width: 75%;">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:Button runat="server" Text="Update All" class="btn btn-info" ID="workupdate" OnClick="workupdate_Click" OnClientClick="return GetWorkorderUpdateConfirmation()"></asp:Button>&nbsp;
                                                        </td>
                                                    </tr>
                                                </table>
                                            </div>
                                            ...
                                            <div>
                                                <table class="table table-bordered" style="width: 90%">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:Button runat="server" Text="Update All" class="btn btn-info" ID="rejupdate" OnClick="rejupdate_Click"></asp:Button>&nbsp;
                                                        </td>
                                                    </tr>
                                                </table>
                                            </div>
                                            ...
                                            <div>
                                                <table class="table table-bordered" style="margin-top: -6px;">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:Button runat="server" Text="Update All" class="btn btn-info" ID="compupdate" OnClick="compupdate_Click" OnClientClick="ShowLoader()"></asp:Button>&nbsp;
                                                        </td>
                                                    </tr>
                                                </table>
                                            </div>
                                            ...
                                            <div>
                                                <table class="table table-bordered" style="width: 90%;">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:Button runat="server" Text="Update All" class="btn btn-info" ID="oprupdate" OnClick="oprupdate_Click" OnClientClick="return ShowLoader() && GetOperatorUpdateConfirmation()"></asp:Button>&nbsp;
                                                        </td>
                                                    </tr>
                                                </table>
                                            </div>
                                            ...
                                            <div>
                                                <table class="table table-bordered" style="width: 90%;">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:Button runat="server" Text="Update All" class="btn btn-info" ID="downupdate" OnClick="downupdate_Click" OnClientClick="ShowLoader()"></asp:Button>&nbsp;
                                                        </td>
                                                    </tr>
                                                </table>
                                            </div>
                                                ...
                                                <ContentTemplate>
                                                    <table>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:Button runat="server" Text="Update All" class="btn btn-info" ID="partsupdate" OnClick="Partsupdate_Click" OnClientClick="ShowLoader()"></asp:Button>&nbsp;
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </ContentTemplate>
                ...
                <div id="divgrd" style="height: 570px; overflow: auto; margin-top: 5px;">
                    ...
                    <%-- Down grid--%>
                    <asp:GridView ID="downdatagrid" CssClass="dataGrid" ClientIDMode="Static" runat="server" AutoGenerateColumns="false" Width="100%" AllowPaging="true" PageSize="1000" HeaderStyle-Font-Italic="true" EmptyDataText="No Data Available." ShowHeaderWhenEmpty="true" ShowHeader="true" HeaderStyle-CssClass="blue" BackColor="#FFFFFF" AlternatingRowStyle-BackColor="#F2F2F2" OnRowDataBound="downdatagrid_RowDataBound" OnPageIndexChanging="downdatagrid_PageIndexChanging" PagerStyle-Font-Bold="true" PagerSettings-Mode="Numeric" PagerSettings-LastPageText="&raquo;&raquo;" PagerSettings-FirstPageText="&laquo;&laquo;" PagerSettings-NextPageText="&raquo;" PagerSettings-PreviousPageText="&laquo;">
                        <Columns>
                            <asp:TemplateField HeaderText="ComponentName">
                                <ItemTemplate>
                                    <asp:HiddenField ID="hdfdownsavecheck" runat="server" />
                                       <asp:Label runat="server" ID="lbComponent" Visible="false" Text='<%# Eval("ComponentInterfaceid") %>'></asp:Label>
                            ...
                            <asp:TemplateField HeaderText="Operation">
                                <ItemTemplate>
                                     <asp:HiddenField runat="server" ID="hfOperation" Value='<%# Eval("Operation") %>' />
                                       <asp:Label runat="server" ID="lbOperation" Visible="false" Text='<%# Eval("Operation") %>'></asp:Label>
                            ...
                            <asp:TemplateField HeaderText="Operator">
                                <ItemTemplate>
                                       <asp:Label runat="server" ID="lbOperatorInterfaceid" Visible="false" Text='<%# Eval("OperatorInterfaceid") %>'></asp:Label>
                            ...
                            <asp:TemplateField HeaderText="Down Code">
                                <ItemTemplate>
                                       <asp:Label runat="server" ID="lbDownId" Visible="false" Text='<%# Eval("DownId") %>'></asp:Label>
                    ...
                    <%-- Rejection grid--%>
                    <asp:GridView ID="rejectiongrd" runat="server" AutoGenerateColumns="false" Width="100%" AllowPaging="true" PageSize="1000" HeaderStyle-Font-Italic="true" EmptyDataText="No Data Available." ShowHeaderWhenEmpty="true" ShowHeader="true" HeaderStyle-CssClass="blue" BackColor="#FFFFFF" CssClass="dataGrid" AlternatingRowStyle-BackColor="#F2F2F2" OnRowDataBound="rejectiongrd_RowDataBound" OnPageIndexChanging="rejectiongrd_PageIndexChanging">
                        <Columns>
                    ...
                    <%-- production grid--%>
                    <asp:GridView ID="datagridproductiondata" runat="server" AutoGenerateColumns="false" Visible="false" Width="100%" PageSize="1000" AllowPaging="true" OnPageIndexChanging="datagridproductiondata_PageIndexChanging"
                        HeaderStyle-Font-Italic="true" EmptyDataText="No Data Available" ShowHeaderWhenEmpty="true" ShowHeader="true"
                        HeaderStyle-CssClass="blue" BackColor="#FFFFFF" AlternatingRowStyle-BackColor="#F2F2F2" CssClass="dataGrid" OnRowDataBound="datagridproductiondata_RowDataBound">
                        <Columns>
                            <asp:TemplateField HeaderText="Component">
                                <ItemTemplate>
    ...
    <script>
        var isProductionDownLogEnabled;
        var splitChild;
        var splitTimer
        ...
        //    debugger;
        //    if (isProductionDownLogEnabled) {

        //        var toDate = $('[id$=txtToDate]').data("DateTimePicker");
        //        if (e.date && toDate) {
        //            toDate.minDate(e.date);
        //            //if ((toDate.date() - e.date) > 1) {
        //            //    toDate.date(e.date.add(1, 'days'));
        //            //}
        //        }
        //    }
        //    else {
        ...
        //    if (isProductionDownLogEnabled) {
        //        debugger;
        //        var fromDate = $('[id$=txtFromDate]').data("DateTimePicker");
        //        if (e.date && fromDate) {
        //            fromDate.maxDate(e.date);
        //            //if ((e.date - fromDate.date()) > 1) {
        //            //    fromDate.date(e.date.subtract(1, 'days'));
        //            //}
        //        }
        //    }
        //    else {
        ...
        prm.add_endRequest(function () {
            ...
            $(document).ready(function () {
                IsProductionDownLogEnabled();
                if ($("#hdnShowWorkOrderNo").val() == "N") {
                    $("[id$=datagridproductiondata] tr td:last-child").hide();
                    $("[id$=downdatagrid] tr td:last-child").hide();
                    $("[id$=datagridproductiondata] tr th:last-child").hide();
                    $("[id$=downdatagrid] tr th:last-child").hide();
                }
                setUpdateTooggle();
                bigDiv.scrollLeft = $('[id*=hdnScrollPos]').val();
            });
        ...
        function IsProductionDownLogEnabled() {
            $.ajax({
                type: "POST",
                url: "ModifiedData.aspx/GetProductionDownLogs",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (response) {
                    var result = response.d;
                    isProductionDownLogEnabled = result;
                },
