...
{
    public partial class ModifiedDataForShanti : System.Web.UI.Page
    {
        ...
        private void setActiveTabs()
        {
            ...
            liSlno.Attributes["class"] = "";
            liSupervisorCode.Attributes["class"] = "";
            liSupplierCode.Attributes["class"] = "";
            ...
            divSlno.Attributes["class"] = "";
            divSupervisor.Attributes["class"] = "";
            divSupplier.Attributes["class"] = "";
            ...
            liSlno.Attributes["class"] = "tabsName";
            liSupervisorCode.Attributes["class"] = "tabsName";
            liSupplierCode.Attributes["class"] = "tabsName";
            ...
            divSlno.Attributes["class"] = "tab-pane fade";
            divSupervisor.Attributes["class"] = "tab-pane fade";
            divSupplier.Attributes["class"] = "tab-pane fade";
            ...
            else if (hdnActiveTabID.Value == "liSlno")
            {
                liSlno.Attributes.Add("class", "tabsName active");
                divSlno.Attributes.Add("class", "tab-pane fade in active");
            }
            else if (hdnActiveTabID.Value == "liSupervisorCode")
            {
                liSupervisorCode.Attributes.Add("class", "tabsName active");
                divSupervisor.Attributes.Add("class", "tab-pane fade in active");
            }
            else if (hdnActiveTabID.Value == "liSupplierCode")
            {
                liSupplierCode.Attributes.Add("class", "tabsName active");
                divSupplier.Attributes.Add("class", "tab-pane fade in active");
            }
            else
            {
                liWorkOrder.Attributes.Add("class", "tabsName active");
        ...
        private void getGriddata()
        {
            try
            {
                ...
                if (ddldatatype.SelectedValue.ToString() == "Production Data")
                {
                    ...
                    ddlFromSlno.DataSource = DataBaseAccess.GetProdDownRejectiondata(StartTime, EndTime, ddlplant.Text.ToString(), MachineInterfaceID, "", "", "", "", "Production Data", "PartSlno");
                    ddlFromSlno.DataBind();
                    ddlFromSupervisor.DataSource = DataBaseAccess.GetProdDownRejectiondata(StartTime, EndTime, ddlplant.Text.ToString(), MachineInterfaceID, "", "", "", "", "Production Data", "FromSupervisorCode");
                    ddlFromSupervisor.DataBind();
                    ddlToSupervisor.DataSource = DataBaseAccess.GetProdDownRejectiondata(StartTime, EndTime, ddlplant.Text.ToString(), MachineInterfaceID, "", "", "", "", "", "ToSupervisorCode");
                    ddlToSupervisor.DataBind();
                    ddlFromSupplier.DataSource = DataBaseAccess.GetProdDownRejectiondata(StartTime, EndTime, ddlplant.Text.ToString(), MachineInterfaceID, "", "", "", "", "Production Data", "SupplierCode");
                    ddlFromSupplier.DataBind();
                ...
                else if (ddldatatype.SelectedValue.ToString() == "Down Data")
                {
                    ...
                    ddlFromSlno.DataSource = DataBaseAccess.GetProdDownRejectiondata(StartTime, EndTime, ddlplant.Text.ToString(), MachineInterfaceID, "", "", "", "", "Down Data", "PartSlno");
                    ddlFromSlno.DataBind();
                    ddlFromSupervisor.DataSource = DataBaseAccess.GetProdDownRejectiondata(StartTime, EndTime, ddlplant.Text.ToString(), MachineInterfaceID, "", "", "", "", "Down Data", "FromSupervisorCode");
                    ddlFromSupervisor.DataBind();
                    ddlToSupervisor.DataSource = DataBaseAccess.GetProdDownRejectiondata(StartTime, EndTime, ddlplant.Text.ToString(), MachineInterfaceID, "", "", "", "", "", "ToSupervisorCode");
                    ddlToSupervisor.DataBind();
                    ddlFromSupplier.DataSource = DataBaseAccess.GetProdDownRejectiondata(StartTime, EndTime, ddlplant.Text.ToString(), MachineInterfaceID, "", "", "", "", "Down Data", "SupplierCode");
                    ddlFromSupplier.DataBind();
                ...
                else if (ddldatatype.SelectedValue.ToString() == "Rejection Data")
                {
                    ...
                    ddlFromSlno.DataSource = DataBaseAccess.GetProdDownRejectiondata(StartTime, EndTime, ddlplant.Text.ToString(), MachineInterfaceID, "", "", "", "", "Rejection Data", "PartSlno");
                    ddlFromSlno.DataBind();
                    ddlFromSupervisor.DataSource = DataBaseAccess.GetProdDownRejectiondata(StartTime, EndTime, ddlplant.Text.ToString(), MachineInterfaceID, "", "", "", "", "Rejection Data", "FromSupervisorCode");
                    ddlFromSupervisor.DataBind();
                    ddlToSupervisor.DataSource = DataBaseAccess.GetProdDownRejectiondata(StartTime, EndTime, ddlplant.Text.ToString(), MachineInterfaceID, "", "", "", "", "", "ToSupervisorCode");
                    ddlToSupervisor.DataBind();
                    ddlFromSupplier.DataSource = DataBaseAccess.GetProdDownRejectiondata(StartTime, EndTime, ddlplant.Text.ToString(), MachineInterfaceID, "", "", "", "", "Rejection Data", "SupplierCode");
                    ddlFromSupplier.DataBind();
        ...
        private void commanDataBind()
        {
            if (Session["downcode"] == null)
                Session["downcode"] = downcode = DataBaseAccess.GetAllParameterWithInteface(DateTime.Now, DateTime.Now, ddlplant.Text.ToString(), MachineName.ToString(), "", "", "", "", "", "Downid");
            else
        ...
        protected void btn_Inconsistency_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (ddldatatype.SelectedValue.ToString() == "Rejection Data" && ddlvalidatedata.SelectedValue.ToString() == "Component-Operation")
                {
                    ...
                    //downdatagrid.DataBind();
                    //downdatagrid.Visible = true;
                    rejectiongrd.DataSource = dtDownData;
                    rejectiongrd.DataBind();
                    rejectiongrd.Visible = true;
                }
                ...
                if (ddldatatype.Text.ToString().Equals("Production Data"))
                {
                    foreach (GridViewRow row in datagridproductiondata.Rows)
                    {
                        ...
                        if (hdfvalue.Value.Equals("updated", StringComparison.OrdinalIgnoreCase))
                        {
                            ...
                            string grdcomponent = ((DropDownList)row.FindControl("Component")).Text;
                            ...
                            string grdoperator = ((DropDownList)row.FindControl("Operator")).Text;
        ...
        protected void oprupdate_Click(object sender, EventArgs e)
        {
            ...
            if (ddlfrmorp.SelectedValue != null && ddlopr_to.SelectedValue != null && ddlmachine.SelectedValue != null && !string.IsNullOrEmpty(txtFromDate.Text) && !string.IsNullOrEmpty(txtToDate.Text))
            {
                ...
                string NewOperatorValue = ddlopr_to.SelectedValue.ToString();
                string MachineID = ddlmachine.SelectedItem != null ? ddlmachine.Text.Split('<')[0].Trim() : "";
                DateTime.TryParse(txtFromDate.Text.ToString(), out Sttime);
                DateTime.TryParse(txtToDate.Text.ToString(), out Ndtime);
                getdatatype(ddldatatype.SelectedValue.ToString(), out Datatype);
        ...
        protected void Partsupdate_Click(object sender, EventArgs e)
        {
            ...
            if (ddlpartcomp.SelectedValue != null && ddlfrmcount.SelectedValue != null && ddlpatsopr.SelectedValue != null && ddlpartstocount.Text != null && ddlmachine.SelectedValue != null && !string.IsNullOrEmpty(txtFromDate.Text) && !string.IsNullOrEmpty(txtToDate.Text) && ddldatatype.SelectedValue != null && ddldatatype.SelectedValue.ToString().Equals("Production Data", StringComparison.OrdinalIgnoreCase))
            {
                ...
                string MachineID = ddlmachine.SelectedValue.ToString();
                string[] mac = MachineID.Split('<');
                DateTime.TryParse(txtFromDate.Text.ToString(), out Sttime);
                DateTime.TryParse(txtToDate.Text.ToString(), out Ndtime);
                getdatatype(ddldatatype.SelectedValue.ToString(), out Datatype);
                int rowCount;
                bool Status = DataBaseAccess.UpdateModifiedPartCountData(Component, Operation, mac[0].Trim(), Sttime, Ndtime, OldPartCount, NewPartCount, Datatype,out rowCount);
                if (Status)
                {
                    lblMessages.Text = rowCount + " Row Updated Successfully.";
                    GetTabInformation();
        ...
        protected void slnoUpdateBtn_Click(object sender, EventArgs e)
        {
            DateTime Sttime = DateTime.Now; int Datatype = 0;
            DateTime Ndtime = DateTime.Now;
            if (ddlFromSlno.SelectedValue != null && txtToSlno != null && !(string.IsNullOrEmpty(txtToSlno.Text)) && ddlmachine.SelectedValue != null && !string.IsNullOrEmpty(txtFromDate.Text) && !string.IsNullOrEmpty(txtToDate.Text))
            {
                string OldSlno = ddlFromSlno.SelectedValue.ToString();
                string NewSlno = txtToSlno.Text.ToString();
                string MachineID = ddlmachine.SelectedItem != null ? ddlmachine.Text.Split('<')[0].Trim() : "";
                DateTime.TryParse(txtFromDate.Text.ToString(), out Sttime);
                DateTime.TryParse(txtToDate.Text.ToString(), out Ndtime);
                getdatatype(ddldatatype.SelectedValue.ToString(), out Datatype);
                int rowCount;
                bool Status = DataBaseAccess.UpdateModifiedSlnoData(OldSlno, NewSlno, MachineID, Sttime, Ndtime, Datatype,out rowCount);
                if (Status)
                {
                    lblMessages.Text = rowCount+" Row Updated Successfully.";
                    GetTabInformation();
        ...
        protected void supervisorUpdateBtn_Click(object sender, EventArgs e)
        {
            DateTime Sttime = DateTime.Now; int Datatype = 0;
            DateTime Ndtime = DateTime.Now;
            if (ddlFromSupervisor.SelectedValue != null && ddlToSupervisor.SelectedValue != null && !(string.IsNullOrEmpty(ddlToSupervisor.SelectedValue)) && ddlmachine.SelectedValue != null && !string.IsNullOrEmpty(txtFromDate.Text) && !string.IsNullOrEmpty(txtToDate.Text))
            {
                string OldSupervisor = ddlFromSupervisor.SelectedValue.ToString();
                string NewSupervisor = ddlToSupervisor.SelectedValue.ToString().Split('<')[0].Trim();
                string MachineID = ddlmachine.SelectedItem != null ? ddlmachine.Text.Split('<')[0].Trim() : "";
                DateTime.TryParse(txtFromDate.Text.ToString(), out Sttime);
                DateTime.TryParse(txtToDate.Text.ToString(), out Ndtime);
                getdatatype(ddldatatype.SelectedValue.ToString(), out Datatype);
                int rowCount;
                bool Status = DataBaseAccess.UpdateModifiedSupervisorData(OldSupervisor, NewSupervisor, MachineID, Sttime, Ndtime, Datatype,out rowCount);
                if (Status)
                {
                    lblMessages.Text = rowCount +" Row Updated Successfully.";
                    GetTabInformation();
        ...
        protected void supplierUpdateBtn_Click(object sender, EventArgs e)
        {
            DateTime Sttime = DateTime.Now; int Datatype = 0;
            DateTime Ndtime = DateTime.Now;
            if (ddlFromSupplier.SelectedValue != null && txtToSupplier != null && !(string.IsNullOrEmpty(txtToSupplier.Text)) && ddlmachine.SelectedValue != null && !string.IsNullOrEmpty(txtFromDate.Text) && !string.IsNullOrEmpty(txtToDate.Text))
            {
                string OldSupplier = ddlFromSupplier.SelectedValue.ToString();
                string NewOldSupplier = txtToSupplier.Text.ToString();
                string MachineID = ddlmachine.SelectedItem != null ? ddlmachine.Text.Split('<')[0].Trim() : "";
                DateTime.TryParse(txtFromDate.Text.ToString(), out Sttime);
                DateTime.TryParse(txtToDate.Text.ToString(), out Ndtime);
                getdatatype(ddldatatype.SelectedValue.ToString(), out Datatype);
                int rowCount;
                bool Status = DataBaseAccess.UpdateModifiedSupplierData(OldSupplier, NewOldSupplier, MachineID, Sttime, Ndtime, Datatype,out rowCount);
                if (Status)
                {
                    lblMessages.Text = rowCount+ " Row Updated Successfully.";
                    GetTabInformation();
