<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SolutionPreview.aspx.cs"
    Inherits="Web_TPMTrakDashboard.SolutionPreview" %>
    <!DOCTYPE html>
    <html>
    ...
    <body>
        <div class="preview-ribbon">PREVIEW MODE</div>
        <form id="form1" runat="server">
            ...
            <div class="card">
                ...
                <p class="subtitle">Dynamic Screen Preview - Grid Context</p>
                    ...
                    <ContentTemplate>
                        <div class="controls-grid">
                            ...
                            <div class="dropdown-container">
                                <asp:Button ID="btnView" runat="server" Text="View Report" CssClass="btn-view"
                                    OnClick="btnView_Click" />
                            </div>
                            <div class="dropdown-container"
                                style="flex-direction: row; align-items: flex-end; gap: 10px;">
                                <asp:Button ID="btnExport" runat="server" Text="Export" CssClass="btn-view"
                                    style="background: #10b981;" OnClick="btnExport_Click" />
                                <asp:Button ID="btnImport" runat="server" Text="Import" CssClass="btn-view"
                                    style="background: #f59e0b;" OnClick="btnImport_Click" />
                            </div>
                        </div>
                ...
                <div class="time-info">
                    ...
                    <span style="color: #f59e0b; font-weight: 600;">ACTIVE PREVIEW</span>
                </div>
            </div>
        </form>
