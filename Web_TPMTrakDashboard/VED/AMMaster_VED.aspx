<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AMMaster_VED.aspx.cs" Inherits="Web_TPMTrakDashboard.VED.AMMaster_VED" %>
            ...
            <ContentTemplate>
                <div>
                    <table class="tblSettings">
                        <tr>
                            <td runat="server" style="width:50px; margin-left:-15px;">Machine ID</td>
                            <td>
                                <asp:DropDownList runat="server" ClientIDMode="Static" CssClass="form-control" ID="ddlMachineID" OnSelectedIndexChanged="ddlMachineID_SelectedIndexChanged" AutoPostBack="true" style="width:210px; margin-left:-24px;"></asp:DropDownList>
                            </td>
                            <td runat="server" style="width:60px;margin-left:-30px;padding: 10px 40px;">Frequency</td>
                            <td>
                                <asp:DropDownList runat="server" ID="ddlFrequency" CssClass="form-control" OnSelectedIndexChanged="ddlFrequency_SelectedIndexChanged" AutoPostBack="true" Width="110px">
                        ...
                        <LayoutTemplate>
                            <table class="table table-bordered headerFixer">
                                <tr>
                                   ...
                                   <%-- <th>Category ID</th>
                                    <th>Category Desc</th>--%>
                                    <th runat="server" id="duedate" visible=<%# Eval("DuedateVisibility") %>>Due Date</th>
                                    <th>Action</th>
                                </tr>
                            ...
                            <tr style="background-color: white; text-align: center;">
                              ...
                              <%--  <td>
                                ...
                                <td>
                                 ...
                                 <td runat="server"  visible=<%# Eval("DuedateVisibility") %>>
                                    <asp:Label runat="server" ClientIDMode="Static" ID="lblDueDate" Text='<%# Eval("DueDate") %>'></asp:Label>
                                </td>
                                <td>
                                    <asp:UpdatePanel runat="server">
                                        <ContentTemplate>
                                ...
                                <div style="padding-left: 15px; padding-right: 15px; padding-top: 8px;">
                                    <table class="modal-tbl" style="width: 100%; margin: auto; color: black;">
                                     ...
                                     <%--   <tr>
                                        ...
                                        <tr runat="server"  id="duedatetr" visible=<%# Eval("DuedateVisibility") %>>
                                             <td runat="server" id="duedate1">Due date</td>
                                            <td id="duedate2" runat="server"> 
                                                <asp:TextBox runat="server" ClientIDMode="Static" ID="txtDueDate" AutoCompleteType="Disabled" Enabled="false"  CssClass="form-control"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                </div>
