<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="InspectionMasterVulkan.aspx.cs" Inherits="Web_TPMTrakDashboard.VulkanMachineShop.InspectionMasterVulkan" %>
                ...
                <div class="bajaj-inner-div-filter-section left-content-filter-section">
                    ...
                    <table class="tblSettings">
                        <tr>
                            ...
                            <td>
                                <asp:Button runat="server" ID="btnView" Text="View" CssClass="bajaj-btn-style" OnClick="btnView_Click" Style="margin-left: 16px; width: 100px;" />
                            </td>
                            <td>
                                <asp:UpdatePanel runat="server">
                                    <ContentTemplate>
                            ...
                            <td >
                                ...
                                <asp:LinkButton runat="server" ID="lnkImport" CssClass="bajaj-btn-style" Text="Import" OnClick="btnImport_Click" Style="margin-left: 12px; width: 130px;" Visible="true" ToolTip="Import" />
                            </td>
                            <td>
                                <asp:UpdatePanel runat="server">
                                    <ContentTemplate>
                                        <asp:Button runat="server" ID="btnEdit" Text="Edit" CssClass="bajaj-btn-style" Style="margin-left: 10px;" OnClick="btnEdit_Click" />
                                        <asp:Button runat="server" ID="btnSave" Text="Save" CssClass="bajaj-btn-style" OnClick="btnSave_Click" Style="margin-left: 10px; margin-right: 10px;" Visible="false" />
                                    </ContentTemplate>
                                </asp:UpdatePanel>
                            </td>
                            <td>
                                <asp:UpdatePanel runat="server">
                                    <ContentTemplate>
                                        <asp:Button runat="server" ID="btnCopy" Text="Copy Inspection Data" CssClass="bajaj-btn-style" OnClick="btnCopy_Click" />
                                    </ContentTemplate>
                                </asp:UpdatePanel>
                            </td>
                        </tr>
