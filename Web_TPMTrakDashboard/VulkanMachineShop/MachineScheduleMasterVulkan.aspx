<%@ Page Title="Schedule Comp-Opn" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MachineScheduleMasterVulkan.aspx.cs" Inherits="Web_TPMTrakDashboard.VulkanMachineShop.MachineScheduleMasterVulkan" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
                    ...
                    <asp:GridView ID="gvScheduleCreate" CssClass="gvScheduleCreate table table-bordered headerFixer" runat="server" AutoGenerateColumns="false" EmptyDataText="No records" ShowHeader="true" ShowHeaderWhenEmpty="true" ClientIDMode="Static" OnRowDataBound="gvScheduleCreate_RowDataBound" ShowFooter="true" AllowPaging="true" OnPageIndexChanging="gvScheduleCreate_PageIndexChanging" OnPreRender="gvScheduleCreate_PreRender" PageSize="100">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Work Order">
                                ...
                                <FooterTemplate>
                                    <asp:TextBox runat="server" ID="txtWorkOrder" CssClass="form-control" ClientIDMode="Static"></asp:TextBox>
                                </FooterTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Work Order Qty.">
                                <ItemTemplate>
                                    <asp:Label ID="lblWorkOrderQty" runat="server" Text='<%# Eval("WorkOrderQty") %>'></asp:Label>
                                </ItemTemplate>
                                <FooterTemplate>
                                    <asp:TextBox runat="server" ID="txtWorkOrderQty" CssClass="form-control allowNumber" ClientIDMode="Static"></asp:TextBox>
                                </FooterTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Priority No">
                                ...
                                <FooterTemplate>
                                    <asp:TextBox runat="server" ID="txtPriority" CssClass="form-control allowNumber"></asp:TextBox>
                                </FooterTemplate>
                            </asp:TemplateField>
    ...
    <div class="modal fade" id="errorModal" role="dialog" style="z-index: 2000">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content modalContent error-modal-content">
                ...
                <br />
                <span class="error-modal-msg" id="lblErrorMsg" style="color: black !important;">...</span>
    ...
    <script>
        ...
        function insertValidation(ctrl) {
            ...
            var workOrder = $(ctrl).closest('tr').find('#txtWorkOrder').val();
            if (workOrder == "") {
                openWarningModal("WorkOrder Can not be Empty.");
                return false;
            }
            else {
                if (workOrder.length > 12) {
                    openWarningModal("WorkOrder should not be greater than 12 char.");
                    return false;
                }
            }
            var workOrderQty = $(ctrl).closest('tr').find('#txtWorkOrderQty').val();
            if (workOrderQty == "") {
                openWarningModal("workOrderQty Can not be Empty.");
                return false;
            } else {
                if (workOrderQty.length > 4) {
                    openWarningModal("workOrderQty should not be greater than 4 digit.");
                    return false;
                }
            }
        ...
        $(".gvScheduleCreate tr .txtUpdate").focusin(function () {
            debugger;
